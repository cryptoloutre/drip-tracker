            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/IGF0NweTM_PaxAK9kOGJ36QNEDMOIEnZvAnqEzvAFCo?ext=jpg"
                    alt="drop 18 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/_9WAY7hUm3EOI6A6mH29-7iMI2zpS1rVnkBS7bdou1c?ext=jpg"
                    alt="drop 19 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/5bg0jCtTs8gG0AnYqQw5xuZW0ErmXhBseIaeY579K-I?ext=jpg"
                    alt="drop 20 preview"
                  ></img>
                </div>
