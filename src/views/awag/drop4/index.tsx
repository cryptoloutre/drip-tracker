      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">DRiP #4 - AWAG / 2023</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 different collectibles:
              ...
              <span className="italic">“SPACE_POPHEAD.jpg”</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 55061)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">“RED_BOT.jpg”</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 750)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">“GREEN_BOT.jpg”</span>{" "}
