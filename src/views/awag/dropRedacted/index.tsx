...
export const DropRedactedAwag: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop Redacted: <span className="italic">“REDACTED_M.gif”</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[40%] w-[100%] flex items-center grid grid-cols-1 md:grid-cols-1 gap-2 mt-4">
