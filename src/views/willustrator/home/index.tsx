...
export const WillustratorHome: FC = ({ }) => {
  ...
  async function getUserNFT() {
    ...
    const _userNFTs = allUserNFTs.filter(
      (asset) =>
        ...
        "HP2WqVmkdxyWt8vwzsgVmfq2k8qExv2HpfmNzmdwD33s"
    );
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">willustrator Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the willustrator DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Having fun and experimenting with art.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/willustrator"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/willustrator"}
            >
              willustrator
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://multitaskersca.wixsite.com/will-ustrator"}
              >
                Website
              </a>
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://twitter.com/will_ustrator"}
              >
                Twitter
              </a>
              <a
          ...
          <DropCards artist="willustrator" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
