  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">NANiEKO😽 Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the NANiEKO😽 DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Nanieko, hailing from the vibrant landscapes of Malaysia. I&apos;m all
            about infusing life into the world of art and animation. I&apos;m a
            full-time freelance 2D animator, and I also dive into the realm of
            NFT creation solo style. My mission? To bring joy and enchantment to
            all through every frame of my creations.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/nani3k0"}
            >
              NANiEKO😽
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/seorangnanie/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="nanieko" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
