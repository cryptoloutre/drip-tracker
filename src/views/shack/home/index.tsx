  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Shack! Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Shack! DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Free art from the mind of “Shack!”.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://leshackgraphique.com/"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/le_shack_graphique/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="shack" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
