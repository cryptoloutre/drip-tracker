  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">DUCKZZY Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the DUCKZZY DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Duckzzy is mobile pixel artist with a flair for blending humor and
            gore in every creation. With a unique touch, Duckzzy crafts pixel
            art that captivates, whether through witty humor or a dash of
            thrilling gore. Expect a delightful twist in each piece, as this
            artist weaves pixelated tales that push the boundaries of
            creativity. Duckzzy&apos;s portfolio is a vibrant fusion of laughter and
            darkness, making for a one-of-a-kind visual experience.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/DUCKZZYOG"}
            >
              DUCKZZY
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://studio.metaplex.com/project/killbuns"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/dvckzzy"}
              >
                Instagram
              </a>
            </div>
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/kkIxi17gKKT7c1VsM9JoXqkJ7QrxkRwB0WdBpZed-oA?ext=jpg"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/esz_tJpYcFh8oWwCApXpQ-7s9pFz0OKebzK70mnDgS8?ext=jpg"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/JmMtgIEOe_LaJE7bi88N4mX-ptwgFaWx7QilvSPsqrQ?ext=jpg"
                    alt="drop 3 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/zDgKt1Ei5uOeCFpmKaUCBKlaxlk8tQk7VvGsSopDuHM?ext=jpg"
                    alt="drop 4 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/VEVEugMpDj05-TRfaZLo56N_5hgbxqsb67O980hZ2Eg?ext=jpg"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/bJgljya1o-hu6ySYM7NMONXxSVWqSpCF-TFtg6gD5WA?ext=jpg"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/K3CseR_8bBsWn9bHJ4nlNkT10M-40faTxmLOPIW-fSk?ext=jpg"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/JJ4cdV5dDFb47GkBZbgT1DPHrQhxLDtyMVcY3Jenock?ext=gif"
                    alt="drop 8 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/MsNs0utySwKWok3FrQJGFpVmvOpEDFUogvUEIiIydkk?ext=gif"
                    alt="drop 9 preview"
                  ></img>
                </div>
