      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop{dropNb}: <span className="italic">{NFTsInThisDrop[0].name}, {NFTsInThisDrop[1].name}, {NFTsInThisDrop[2].name} & {NFTsInThisDrop[3].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            This drop features 3 rarities:
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 41548)</span>
              .<br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 300)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 200)</span>
              .<br />
              <br />• The{" "}
