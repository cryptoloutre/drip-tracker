  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Mapez Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Mapez DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Discover distinctive digital collectibles created by Mapez, a Berlin-based digital artist who uses 3D technology as a primary medium of his artistic expression.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/mapez_sol"}
            >
              Mapez
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://exchange.art/mapez/nfts"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/marlon.epes/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="mapez" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
