      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">Trading Card</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Trading cards by BAD* Environment Club! Holders of rare cards will
              be entered into a raffle for a free character or WL spot in
              anticipation for our upcoming PFP mint..
            </div>
          </div>
