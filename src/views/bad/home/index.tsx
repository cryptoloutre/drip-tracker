  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">BAD* Environment Club Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the BAD* Environment Club NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          We drop cool stuff from time to time. Don&apos;t subscribe to us.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://www.badenvironment.club/"}
              >
                Website
              </a>
              <a
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/gS2QoID63MFIpjl9IG-5CLVWNhkVTVAyPxAtZFcjPbY?ext=png"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/7vnEmZ6rP96FPTx3E6QYz6BGuCPs7OtWueRZRcOveh0?ext=png"
                    alt="drop 3 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/WQSUWSPrjowOaFITVrRftPRhsO9jWOXrg8dMXKdyVl8?ext=png"
                    alt="drop 4 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/cpFPirvsucETmzHcXXVMmfWTNIviHoI61qFK8kirk1o?ext=png"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/FL-dkuYELTsW9UndzXjCzaub30E0cpRhX07eZ1fYfTU?ext=png"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/sAt4xzh6xZOpXFSa00MoKOGuZp8zSeRs0XBd0MCcQLE?ext=png"
                    alt="drop 8 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/F2mlE0jpvFo4UjV5KKscaYaRPoA7ThLvNgnczu3aCtI?ext=png"
                    alt="drop 9 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/6htxjVHIbL6u_vSvHBpv0d6ugyvfTgLi3Z63hWQmt_s?ext=png"
                    alt="drop 10 preview"
                  ></img>
                </div>
