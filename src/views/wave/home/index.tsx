  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">The Wave Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the The Wave DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            The Wave is a channel dedicated to interviewing the brightest minds
            in web3, and beyond. The Wave is hosted by Wombat (
            <a
              target="_blank"
              rel="noreferrer"
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/Solwookie"}
            >
              @Solwookie
            </a>
            ).
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/TheWavesolana"}
            >
              The Wave
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://www.youtube.com/channel/UC862zIfCetvH9zCaBGv67Uw"}
              >
                Youtube
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/thewavesolana"}
              >
                Instagram
              </a>
            </div>
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/cfdD5VpFqTXi_H352Xh7QmEWMvzAWa-l-l4x5WIxghI?ext=jpg"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/D0S8ut4CFy2mEQGmUknNZU68JaGKebtp4RSU5RC8kCg?ext=png"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/PyHf6NpjPJS36_Amg-hEBCuqfBpBsF27ydHmL-Fz67k?ext=png"
                    alt="drop 3 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/-LrzYsu1Ma0-moekz7sFgSPJyBExLNYztdAcWmDQTck?ext=png"
                    alt="drop 4 preview"
                  ></img>
                </div>
