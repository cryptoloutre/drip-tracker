      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop18: <span className="italic">{NFTsInThisDrop[0].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              In case the title didn’t make it clear, this jpeg is letting you
              know that V2 launches today
            </div>
          </div>
