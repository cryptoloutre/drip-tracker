      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop9: <span className="italic">Great Power, No Responsibility</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>Let&apos;s at least wait till it rains and see if you change your mind</div>
          </div>
