            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/XukYWD_ToVj7ciCR5qeocxbPlVf90AZLVzUeiO96gyU?ext=jpeg"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/jXRZEBtf08g5qRFizMfcRwu0MetPKi8bby-8XbSViNI?ext=jpg"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/inuEncecgBuly36wUYTiuQwh_c8LSE9A6iWUVUKizbc?ext=jpeg"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/OLLH7PLD9P3ysvsGzGsob0ybGbtQiHDmNTZ119eNWPY?ext=jpeg"
                    alt="drop 8 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/znJHr2jJNUOxUS0etbBRV1uPOlnhV-lspexFRd2DkG4?ext=jpeg"
                    alt="drop 9 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/yewLZpLSev0_6mzqz32se16yvDm3q6zfmtl0YS5OSHk?ext=jpg"
                    alt="drop 10 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/NIUWoaxRN8BmIPVPPyPMKud5C_GO_weuxe3ID9kEGL0?ext=jpg"
                    alt="drop 11 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/wGfbSAvWPoOF35sk6XznzIJ0HKt9MBzhmtIyD_ay5TE?ext=jpeg"
                    alt="drop 12 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/15DcwYnjsc48XFNOXV7syfpjvWUJVx9lg6W1zCWKjkY?ext=jpg"
                    alt="drop 14 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/3r7eMhB0c_W5Ti5dlzDVN-Ci5X3894apTUJib1AcnjE?ext=jpg"
                    alt="drop 15 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/uDCFrQeLJWpsLqpi2sIa5W3Nlf9afypEFKzJetY-AkE?ext=jpg"
                    alt="drop 16 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/FP2dHlK0FQWtBl6MG3Kj_Lk2kup-keaKEa72Vb_mJyM?ext=jpg"
                    alt="drop 17 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/BIY-Bv3n_ktFTqit40FlnrgeFiFqescMDZl2cUnX9DA?ext=png"
                    alt="drop 18 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/8UJTD0rB4oFzicBaxZGUoIwsw-NWPFnkq8iHxHDAsNo?ext=gif"
                    alt="drop 19 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/9ZTbVcaDrtkI944uPcM5kKSgKy38LcuSJg_qew0BAAs?ext=jpg"
                    alt="drop 20 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/QMnzTsvBjb3mGg4esa1DOEpr4msyu6xAG9MJxn4yGTM?ext=jpg"
                    alt="drop 21 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/tTGUhDaH4MjiP_t1GH8AUrBGIVgqOWT1YwXu9-XPbZA?ext=jpg"
                    alt="drop 21 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/6dzXrD8XoQnGzaw6NZ2I0UbPsPUnkPmQR6r6CaxMz0o?ext=jpg"
                    alt="drop 23 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/sgFwrLRRIcd1mEgtB8BH83UeC3-urUypWnzVYFjlzXc?ext=jpg"
                    alt="drop 25 preview"
                  ></img>
                </div>
