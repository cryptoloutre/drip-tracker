      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">I&apos;m Not Going To Lick It</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>It does look tasty though...</div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="grid sm:w-[70%] grid grid-cols-2 flex items-center gap-4 mt-4">
