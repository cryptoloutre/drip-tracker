      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop10: <span className="italic">OPOS</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>If it’s on a sign that means it’s true</div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[70%] flex items-center grid grid-cols-2 md:grid-cols-3 gap-2 mt-4">
