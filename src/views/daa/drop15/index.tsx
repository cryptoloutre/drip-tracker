      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop15: <span className="italic">Origin of Best Friends</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            A behind the scenes look at the concepting for our recent animation with Magic Eden.
            </div>
          </div>
