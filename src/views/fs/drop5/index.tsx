      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">DRiP STEPNEMBER2</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <br />
              <br />
              GNT prompts by Madivaan: a festive rainbow cake with a colorful
              and vibrant sneaker on top, black background, digital art, in the
              style of color splash, nightcore, detailed texture, romantic
              illustrations, anime-influenced GNT prompts by Tatsiana: Sneakers
              Anniversary cake with sneakers in the form of decorations on top
              of the cake. Gold, light green and blue. Fanfare and tinsel around
              the cake. The background is black with splashes of colors. FullHD
              intricate, highly detailed, digital painting, artstation, concept
              art, smooth, sharp focus, illustration, cinematic, vfx.
            </div>
          </div>
