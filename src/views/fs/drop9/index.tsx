      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              This week, we&apos;re taking a creative twist! Instead of our usual AI
              Generated Art, we&apos;re showcasing a collage that celebrates our
              wonderful community members. At Find Satoshi Lab, the creators
              behind STEPN, MOOAR, and Gas Hero, we believe in the power of
              collaboration and unity. Explore our collage and discover the
              faces that make our community unique and diverse.
            </div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[30%] w-[70%] flex items-center grid grid-cols-1 md:grid-cols-1 gap-2 mt-4">
