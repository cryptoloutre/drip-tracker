      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">DRiP Doge Genesis</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <br />
              <br />
              GNT prompts by Madivaan: Space Doge: Doge dog wearing spacesuit in
              the galaxy, expressive art, in the style of fauvist colour
              explosions, colourful landscapes, detailed design, darkly romantic
              illustrations, pinkcore, anime-influenced, black background WAGMI
              Doge: Doge dog with sunglasses wearing colourful sneakers,
              expressive portrait gesture, in the style of highly detailed
              illustrations, colourful costumes, zbrush, dark amber, shoe
              paintings, full body, pinkcore, anime-influenced, black background
              Running Doge: Doge dog running fast with beautiful sneakers, in
              the style of expressive manga style, colourful and energetic,
              hyper-detailed illustrations, realistic oil paintings, black
              background, playful character design.
            </div>
          </div>
