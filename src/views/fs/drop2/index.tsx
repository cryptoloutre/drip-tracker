      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">DRiP STEPN Fusion</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <br />
              <br />
              GNT prompts by Madivaan: Unicorn sneaker: An exotic sneaker shaped
              like a unicorn&apos;s head and horn, rainbow colors, fun cartoon style,
              side view, in the style of digital airbrushing, neonpunk, 32k uhd,
              colorful drawings, color splash, sparklecore, black background
              Elephant sneaker: a high-top sneaker shaped like an elephant&apos;s
              head and trunk, colorful African patterned textures, digital
              illustration, side view, in the style of digitally enhanced, 8k,
              colorful drawings, black background Octopus Sneaker: Orange
              sneaker shaped like an octopus, detailed suckers and tentacles,
              black inky splotches, glittery ocean aura, front view, digital
              art, electric color, meticulous detailing, 32k uhd , black
              background
            </div>
          </div>
