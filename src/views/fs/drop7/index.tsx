      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop7: <span className="italic">{NFTsInThisDrop[0].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <br />
              <br />
              GNT prompts by SPMaster0310: Teenager pirate girl, anime, wild
              looks, sharp eyes, detailed masterpiece, beautiful, beautiful
              face, wild look, highly detailed, Amano, perfect body, dark color,
              vibrant, hand-painted, Yoshitaka Amano, Karol Bak GNT prompts by
              ParadoxLol: Character upgrade screen for a pirate game, character
              upgrade screen, game user interface, very detailed, extreme
              detail, high detail, full color spectrum, 32k, ultra high
              resolution, UHD, global lighting, frontal lighting, breathtaking,
              beautiful, amazing, awe-inspiring, aerial view, intense mood,
              vibrant, colors gorgeous, stunning graphics, intense, intricate
              details, finely detailed, octane render, Color Grading, Ultra-Wide
              Angle, Depth of Field, DOF, Tilt Blur, Shutter Speed 1/1000, F/22,
              Gamma, UHD GNT prompts by invisiblekull: A Male Pirate Concept art
              portrait by Casey Weldon, Olga Kvasha, Miho Hirano, hyper detailed
              intricately detailed gothic art trending on Artstation triadic
              colors Unreal Engine 5 detailed matte painting, deep color,
              fantastical, intricate detail, splash screen, complementary
              colors, fantasy concept art, 8k resolution, gothic deviantart
              masterpiece.
            </div>
          </div>
