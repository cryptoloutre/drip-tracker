      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">DRiP Alien Spore Lord</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <br />
              <br />
              GNT prompt: Spore Lord video game character, Alien, Gas Hero, with
              armor and weapons, disney pixar animated, frontal view, centered
              image, full body length character, a high-res digital design,
              volumetric lighting.
            </div>
          </div>
