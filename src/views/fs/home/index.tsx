            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/vqToj1gIljovND_h00TTU_VXbezUFEk7qysOGAv7330?ext=png"
                    alt="drop 19 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/m0A6f3oZJZHjORt5Tm4f18LiIUwfKhA0FqtXv9uGUlc?ext=png"
                    alt="drop 20 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/V6FuA2SNeJwOh8MehCRiBCbjQwQIm8LpmFEz_7RrqDg?ext=png"
                    alt="drop 21 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/8TxLAAgJfBYg4WeiROhdoRAt0sEdM1w5UPJQx15pDQM?ext=png"
                    alt="drop 22 preview"
                  ></img>
                </div>
