      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2:{" "}
            <span className="italic">The Grocery Store Balcony Jump</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              This is undoubtedly my most notorious prank I have ever pulled
              off. Filmed back in 2017 with the nelk boys “Fake grocery store
              employee quitting prank” where I jump off a 1 story balcony onto
              granola bars.
            </div>
          </div>
