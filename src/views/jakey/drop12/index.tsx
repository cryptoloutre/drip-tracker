      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              This was my first time public speaking at a conference, grateful
              and humbled to have done the opening keynote for the DRiP HAUS
              powered by Phantom event, here&apos;s my intro.
            </div>
          </div>
