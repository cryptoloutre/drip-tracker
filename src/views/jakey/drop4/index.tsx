      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4:{" "}
            <span className="italic">Jakey vs Slackline</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            The craft of a “nutshot” is a real thing, and this is undoubtedly my most painful one to date.
            </div>
          </div>
