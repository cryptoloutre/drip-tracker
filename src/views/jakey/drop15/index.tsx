      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop{dropNumber}:{" "}
            <span className="italic">{NFTsInThisDrop[0].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            Welcome to my second reoccuring weekly DRiP DROP, these Tuesday drops will act as a way to promote or give early access to my new Web 2 vlog series! \nMake sure to subscribe here to see all the episodes: https://www.youtube.com/@GoodTimeFilms
            </div>
          </div>
