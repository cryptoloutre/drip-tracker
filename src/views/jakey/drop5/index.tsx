      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">Jakey x Steve-o</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              I manifested back in 2016 that I would work with my idol Steve-o.
              In 2019, I got the opportunity to collaborate with him. “The
              tribal tramp stamp” was born on my tailbone in efforts for Steve
              to become a professional tattoo artist!
            </div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[50%] w-[100%] flex items-center grid grid-cols-2 md:grid-cols-2 gap-2 mt-4">
