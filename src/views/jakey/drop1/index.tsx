      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">MIME VS SCOOTER</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            For the special occasion of my first drop I wanted as many people as possible to own one of my most viral videos as a collectible.
            </div>
          </div>
