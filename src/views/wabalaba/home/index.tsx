  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Wabalaba Land Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Wabalaba Land DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            An ever evolving universe of unique characters from the Wabalaba
            universe. We aim to become an established brand and onboard all
            web2-3 users with our art and content.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/wabalabaland"}
            >
              Wabalaba Land
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://buddies.wabalabaland.com/"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://twitter.com/itsnot_demarco"}
              >
                Twitter
              </a>
            </div>
