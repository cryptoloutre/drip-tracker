...
export const MugenHachiHome: FC = ({}) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Hachi Mugen Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Hachi Mugen DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Music saved my life. Not everyone gets a second chance. The Ethereal
            Enclave collapsed and mostly everyone was left for dead or thought
            to be… now what’s left is us. Those who see opportunity despite
            tragedy and loss... We were BORN TO R1S3. Hachi Mugen was BORN TO
            R1S3. Welcome to my story.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/mugenhachi"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/MugenHachi"}
            >
              Hachi Mugen
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://bento.me/mugenhachi"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://open.spotify.com/intl-fr/artist/3hDJYneesxvXUW0RbShXIE?si=fBEqMv6GTJ2_jng4aFo9bw"}
              >
                Spotify
              </a>
            </div>
          ...
          <DropCards artist="mugenhachi" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
