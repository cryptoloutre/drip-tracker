  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Nachopcors Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Nachopcors DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Nachopcors is an architect and 3D artist whose abstract art is influenced by the nuances of everyday life. 
          His designs interweave the simplicity of daily experiences with the complexity of architectural concepts, creating a unique balance between the ordinary and the imaginative. 
          His work reflects a blend of reality and abstraction, bridging the gap between tangible experiences and artistic expression.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/nachopcors"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/nachopcors"}
            >
              Nachopcors
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://linktr.ee/nachopcors"}
              >
                Website
              </a>
              <a
          ...
          <DropCards artist="nachopcors" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
