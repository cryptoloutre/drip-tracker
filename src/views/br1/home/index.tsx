  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">BR1: INFINITE Drop</h1>
          ...
          <div className="mt-8 sm:w-[70%] mx-auto">
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/BR1INFINITE"}
            >
             BR1: INFINITE
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://magiceden.io/creators/br1infinite"}
              >
                Magic Eden Creator Page
              </a>
            </div>
          </div>
          {!wallet.publicKey && !isXNFT && (
          ...
          <DropCards artist="br1" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
