      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">Let It Kill You</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            You&apos;re going to die so find what you love and let it kill you
            </div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[30%] w-[70%] flex items-center grid grid-cols-1 md:grid-cols-1 gap-1 mt-4">
