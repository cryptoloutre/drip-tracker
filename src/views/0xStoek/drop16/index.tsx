        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 43,4k)</span>
              .<br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 427)</span>
              .<br />
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 33)</span>.
            </div>
          </div>
