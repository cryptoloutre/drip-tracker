      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">The Genesis</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            “For every dark night there’s a brighter day” - Tupac. Graffiti gm throwie with an animated sunrise fill | 4k | mp4
            </div>
          </div>
