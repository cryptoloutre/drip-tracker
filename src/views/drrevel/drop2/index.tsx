...
export const Drop2DrRevel: FC = ({}) => {
  ...
  const wisdom = ["Dhamma", "Sārīra", "Paritta"]
  ...
  async function getUserNFT() {
    ...
    await Promise.all(
      season2NFT.map(async (asset) => {
        ...
        const drop = attributes.find((nft) => nft.trait_type == "Wisdom").value;
        if (wisdom.includes(drop)) {
        ...
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 34,3k)</span>
              <br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 1k)</span>
              <br />
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 200)</span>
            </div>
          </div>
