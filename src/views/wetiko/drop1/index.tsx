      ...
      <div className="md:hero-content flex">
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              The most challenging part of an evening stroll. Created
              traditionally using acrylic, marker, colored pencil, spray paint
              and collaged cutouts. 16” x 16” on illustration board.
            </div>
          </div>
