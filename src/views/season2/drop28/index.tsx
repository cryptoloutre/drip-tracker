      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop28: <span className="italic">MONMONMON</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/peelanderz"}
            >
              @peelanderz
            </a>
          </h1>
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              A 700k generative PFP drop from{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              from a full set of 13 million. In partnership with{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              , they are bringing you a new collecting experiment and card game.
            </div>
          </div>
