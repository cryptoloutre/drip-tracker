      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop16: <span className="italic">Glyphscapes</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/zen0m"}
            >
              @zen0m
            </a>
          </h1>
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              ) has worked with video game giants Ubisoft, Activision, Riot,
              Respawn, Gearbox, and SEGA. His signature style encompasses retro
              characters rendered with pixels in dark, fantasy-inspired
              environments. <br />
              Glyphscapes (
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/glyphscapes"}
              >
                @glyphscapes
              </a>
              ) is his new project: A generative, algorithmic art project
              launching on{" "}
              <a
                target="_blank"
                rel="noreferrer"
              ...
              on July 13. Created on a 2048-pixel canvas, each piece will be
              generated on-chain through a unique seed at the time of mint. No
              two pieces are alike. <br />
              Zen0 commemorates this upcoming project with a PFP, a piece of
              history, and an incredible mosaic. As an easter egg, all images
              are 2048px - the supply of{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              <span className="italic">Temple Goblin</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 370732)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">Glyphscapes Nether Concept Art</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 19425)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">Glyph Mosaic</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 3885)</span>.
            </div>
          </div>
