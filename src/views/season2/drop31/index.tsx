      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
              Enjoy the inaugural edition of ECHO Magazine, made by{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/bat_guilhermee"}
              >
                @bat_guilhermee
              </a>{" "}
              from{" "}
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/BAT_Community"}
              >
                @BAT_Community
              </a>{" "}
              on behalf of{" "}
              ...
              . The magazine ships with 3 covers, a Legendary, Rare, and Common
              edition.
              <br />
              Use the play button on DRiP to flip through every page.
              <br /> You can also use our{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://drip-tracker.vercel.app/reader"}
              >
                reader
              </a>
              . Or, if you&apos;d like, the full edition as a PDF is available
              in the collectible&apos;s metadata, permanently stored.
              <br />
              <br />
