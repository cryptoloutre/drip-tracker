            ...
            <div className="w-[70%] flex items-center grid grid-cols-2 sm:grid-cols-4 gap-2 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=" px-2 py-2"
                    src="https://arweave.net/D-plUgDWlZvSHnfFdYR35YiH-D3heUmhc2v4dwWo600?ext=png"
                    alt="drop 27 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=" px-2 py-2"
                    src="https://arweave.net/RpjjegLNIX5TWbImxhhMt9HP39qZgMiPiXWhIpT2AxU?ext=jpg"
                    alt="drop 27 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=" px-2 py-2"
                    src="https://arweave.net/t7_ySIfQ5BYoybsliMYyyBnmOPH6_b73RRpt3m3PniI?ext=png"
                    alt="drop Roundies Teens preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
                Roundies Teens
