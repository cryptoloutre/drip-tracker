      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop17: <span className="italic">Glyphscapes</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
              Who is Bretty Colby? <br /><br />
              An expressionist painter, the life of {" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              has been anything but ordinary. Brett&apos;s older brother, and 10
              of his closest friends, died from debilitating drug addictions.
              <br />
              His paranormal art helped him escape death...
              <br /><br />
              Born in Lawrence, Massachusetts, Brett (
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              ) grew up tagging trains with graffiti under the street name
              &quot;Motz&quot;. When his brother died at age 27 from an
              overdose, Brett struggled with addiction. Every close friend
              suffered similar fates; death was an expectation.
              <br /><br />
              Headed for certain death, Brett broke the cycle through writing
              and art. He turned his emotions into paintings. He immersed
              himself in the paranormal and strange, and fell in love with HP
              Lovecraft, Strange Fiction, and Chaos Magick. Soon, he&apos;ll
              debut a hand-painted collection on Bitcoin called &quot;Alien
              Ordinals&quot;. Later this year, a memoir. The collection today is
              an homage to his upcoming project, and his source of inspiration.
              These are all hand-painted and photographed for DRiP.
              <br /><br />
              Each collectible today tells a paranormal story. But to learn more
              about what they mean, follow{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              <span className="italic">Dream Walker</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 419375)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">Draco Shapeshifter</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 21790)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">The Sleeper of R’yleh</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 4358)</span>.
            </div>
          </div>
