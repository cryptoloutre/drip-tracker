      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop15: <span className="italic">Model</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Born in Brazil, Marculino uses Aseprite for drawing and animation.
              His latest PFP collection,{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/Bit_Dudes"}
              >
                @Bit_Dudes
              </a>
              , changed the PFP game together with{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/fivedollarnft"}
              >
                @fivedollarnft
              </a>{" "}
              , bringing people high-quality art for a low price. His creative
              mind is also behind{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/kokomonkes"}
              >
                @kokomonkes
              </a>{" "}
              and{" "}
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/n00unsNFT"}
              >
                @n00unsNFT
              </a>
              .<br />
              These pieces are banners, perfectly created to spec for Twitter
              and other platforms. The pieces are inspired by the post-futurist
              theme present in &quot;Tales of Sky&quot; with steampunk and
              racing elements in Marculino&apos;s favorite colors. Set in the
              year 3014.
              <br />
              <br />
              ...
              <span className="italic">Model-010</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 334791)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">Model-001</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 17366)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">Cargo Model-069</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 3473)</span>.
            </div>
          </div>
