      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop22: <span className="italic">The Queen of Three Dragons</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/lateduke"}
            >
              @lateduke
            </a>
          </h1>
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
              Duke Nguyen, better known as Duke +1 (
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              ) is a 2022 World Illustration Awards Winner that fuses modern
              concepts with Asian heritage, European design, and poster art. His
              use of shapes and colors makes his work recognizable and striking.{" "}
              <br />
              <br />
              This piece is a banner cut into 3 components, featuring three
              dragons, Neftisu, the Red-Eyes Dragon, Suteku, the Blue-Eyes
              Dragon, and Oshirisu, the Green-Eyes Red Dragon, flanking Queen
              Deināri.
              <br />
              <br />
              ...
              <span className="italic">Neftisu The Red-Eyes Dragon</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 473490)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">Suteku The Blue-Eyes Dragon</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 24933)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">Oshirisu The Green-Eyes Dragon</span>{" "}
