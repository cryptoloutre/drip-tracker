      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop23: <span className="italic">ART IS NOT A CRIME!</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/le_shackgraphic"}
            >
              @le_shackgraphic
            </a>
          </h1>
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
              ...
              ) is a 19-year old artist from Québec, Canada. He creates colorful
              characters and small animations inspired by cartoons, anime,
              street fashion, comics, and graffiti. <br />
              <br />
              These pieces are inspired by his &quot;ART IS NOT A CRIME&quot;
              Series.
              <br />
              SHACK!:
              <br />
              <br />
              &quot;Unfortunately in many parts of the world individuals are
              persecuted, arrested, and even killed for creating and sharing
              their art. Art is not a crime. We must stand up for the right to
              create and share.&quot;
              <br />
              <br />
              ...
              <span className="italic">In The Shadow : Page 1</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 491992)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">In The Shadow : Page 2</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 25965)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">In The Shadow : Page 3</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 5193)</span>.
            </div>
          </div>
