      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">Skate Deck</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/TOUGHIESnft"}
            >
              @TOUGHIESnft
            </a>
          </h1>
          <div className="mt-12 w-[70%] mx-auto">
            ...
            <div>
              Toughies is a 100-piece PFP collection on{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/AbbieSolana"}
              >
                @AbbieSolana
              </a>{" "}
              &{" "}
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/faceless_sol"}
              >
                @faceless_sol
              </a>
              . This collection of pixel PFPs might be shy on the outside, but
              they are tough on the inside. Toughies are a community of artists,
              traders & coffee lovers, inspired by street & pop culture. <br />
              Skate Decks are 3D models, you can zoom, pan, and spin them in{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              <br />
              <br />
              This drop features 3 different collections of 5 decks each: <br />
              • The <span className="text-[#a5a5a5] font-bold">
                Common
              </span>{" "}
              drops are from{" "}
              <span className="font-bold">&quot;The Play Collection&quot;</span>
              . Each colorways represents{" "}
              <span className="text-[#a5a5a5] font-bold">12%</span>.
              ...
              . Each colorways represents{" "}
              <span className="text-[#E6C15A] font-bold">5%</span>.
              <br />• The{" "}
