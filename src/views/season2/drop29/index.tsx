      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop26: <span className="italic">{NFTsInThisDrop[0].name}, {NFTsInThisDrop[1].name} & {NFTsInThisDrop[2].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
              💧 Collect and win a limited edition Aqua Genopet, the first new
              collection of pets on Solana since the Genesis Genopets. Plus,
              sign-up{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://d.rip/genopets"}
              >
                here
              </a>{" "}
              for their new DRiP channel. Everyone on DRiP today received a
              reward.
              <br />
              The first step is signing up for Genopets and linking your DRiP
              Wallet. You can do this right from the DRiP Vault with their new
              Quest feature, or simply visit{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"http://genopets.me/drip"}
              >
                Genopets&apos;s website
              </a>
              . Use code &quot;DRIP&quot; and receive an exclusive welcome pack.
              <br />
              Once you have downloaded Genopets, have a Genopets account, and
              link your wallet that owns your Genopets x DRiP collectibles, you
              will see an upcoming snapshot{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://mainframe.genopets.me/drip/prizes"}
              >
                here
              </a>
              . Hold until October 12.
              <br />
              Holders of the Legendary 🟪 Echo Canyon collectible have the
              highest chance to score a new Aqua Genopet. Only active players
              will be able to claim their prize, so make sure you start playing
              by banking your steps once you create your account.
              <br />
              <br />
              This drop features three collectibles:
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span>{" "}
              <span className="italic">{NFTsInThisDrop[0].name}</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 434973)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">{NFTsInThisDrop[1].name}</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 22796)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">{NFTsInThisDrop[2].name}</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 4559)</span>.
            </div>
          </div>
