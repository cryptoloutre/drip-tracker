      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1:{" "}
            <span className="italic">Messi&apos;s World Cup Masterclass</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              December 18th, 2022: Leo Messi leads Argentina as they defeat
              France in penalties to win the 2022 World Cup.
              <br />
              Artist:{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/basketNFT"}
              >
                @basketNFT
              </a>
            </div>
            ...
            <div className="sm:w-[75%] flex items-center grid grid-cols-1 md:grid-cols-1 gap-2 mt-4">
              {NFTsInThisDrop.map((currentNft) => (
                <div key={currentNft.uri} className="flex justify-center">
                  <div
                    className={`bg-[#000000] w-[70%] sm:w-[40%] border border-4 ${
