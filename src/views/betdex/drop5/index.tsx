      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">28-3</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
              February 5th, 2017: Tom Brady leads the New England Patriots to
              one of the most unlikely comeback wins in sports history. Down
              28-3 midway through the 3rd quarter, the Patriots stormed back to
              win Super Bowl LI in an Overtime thriller. Once again, Brady
              proves the haters wrong.
              <br />
              Artist:{" "}
              <a
                target="_blank"
