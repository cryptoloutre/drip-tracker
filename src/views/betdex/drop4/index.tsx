      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">Air Sol to the moon</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
              Paying homage to one of the most iconic athletes in the history of
              sports, Artsy and BetDEX are taking Solana to new heights.
              <br />
              Artist:{" "}
              <a
                target="_blank"
