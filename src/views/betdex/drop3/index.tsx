      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">The Dagger</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
              May 12th, 2019: Kawhi Leonard hits an epic buzzer beater in Game 7
              to advance Toronto to the Eastern Conference Finals. The Raptors
              would go on to defeat the Bucks and the Warriors to claim the 2019
              NBA Championship. Kawhi&apos;s shot, considered by many as one of the
              best buzzer beaters of the last decade, hit the rim four times
              before finally bouncing in.
              <br />
              Artist:{" "}
              <a
                target="_blank"
