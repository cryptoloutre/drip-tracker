      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">The Queen of Queens</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[90%] mx-auto">
            ...
            <div>
            With the US Open Tennis finals coming up this weekend, Artsy and BetDEX pay homage to Serena Williams, one of the goats of the sport.
              <br />
              Artist:{" "}
              <a
                target="_blank"
