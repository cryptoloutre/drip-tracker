  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Rafaqin Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Rafaqin DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Rafaqin is a Pixel Artist and Animator based on Solana. With 14 years of experience, Rafaqin brings a mix of expertise to the table from in-depth pixelated illustrations all the way to high quality animations.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/Rafaqin"}
            >
              Rafaqin
            </a>{" "}
            DRiP drop.
          ...
          <DropCards artist="rafaqin" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
