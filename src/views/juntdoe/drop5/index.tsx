...
export const Drop5Juntdoe: FC = ({}) => {
  ...
  const dropNumber = "MICROGLOOM x Maquin";
        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 39,9k)</span>
              .
              ...
              <span className="text-[#14F195] font-bold">(supply: 42)</span>.
            </div>
          </div>
