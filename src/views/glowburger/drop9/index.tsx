...
export const Drop9Glowburger: FC = ({}) => {
        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 rarities:
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 32k)</span>
              .<br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 1.8k)</span>
              .<br />
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 325)</span>.
            </div>
          </div>
