...
export const Drop3Glowburger: FC = ({}) => {
        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 rarities:
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 47263)</span>
              .<br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 1990)</span>
              .<br />
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 498)</span>.
            </div>
          </div>
