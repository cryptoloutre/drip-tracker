...
export const GlowburgerHome: FC = ({}) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Glowburger Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Glowburger NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Glowburger is a 3D digital artist based in Singapore who enjoys
            blending the realistic with the whimsical. Through her depiction of
            a character with a burger head, she hopes to (tastefully) explore
            the theme of the authentic self.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/glowburger"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            ...
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://glowburger.framer.ai/"}
              >
                Website
              </a>
              <a
          ...
          <div className="flex justify-center">
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              <Link
                href="/glowburger/drop1"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/nCV7-AI5L-uuhdQdhwNfSj_23dSBSCMUOH8d1kXIyVA?ext=jpg"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/glowburger/drop2"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/D5bg2TWEtWqf5agifVE5VqS4ayOPVz0VXM2wMgJibfo?ext=jpg"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/glowburger/drop3"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/QOAW-4i0VptQ2vj96q1giA3hoXWBkD7I7Wmrof-zfrI?ext=gif"
                    alt="drop 3 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/glowburger/drop4"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/u2wjEqUTiKv3l6vbYZc3NdItTpKi60wV8sj7v3B9H1I?ext=gif"
                    alt="drop 4 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/glowburger/drop5"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/UYxLtJjHAwvzmKy-NyVGeX-YBte6FEnOdJrBsj0W1yk?ext=gif"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/glowburger/drop6"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/-sUtNLTqLGSKpJGbEAoPXzlN42hAF-v01_caf1v8nko?ext=gif"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/glowburger/drop7"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/1u6KRMyZ_SyK22rWCSenDPljwTiHxCATnemV_3URdUU?ext=gif"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/glowburger/drop8"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/xVc-l9PDF9tb8dYGiAO-tonl_cEOBXE-HSsWIV3wWH4?ext=gif"
                    alt="drop 8 preview"
                  ></img>
                </div>
