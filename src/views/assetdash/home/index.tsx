  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">AssetDash Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the AssetDash DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Each Super DRiP you collect grants you exclusive access to a Super
            Drop on AssetDash. Super Drops are a game where you can win epic
            NFTs and other prizes - you can only participate if you own specific
            NFTs. Sign up to AssetDash, verify your wallet with the latest
            AssetDash Super DRiP cNFT, and get exclusive access to the next
            Super DRiPS Drop for a chance to win your favorite NFTs and more!
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/assetdash"}
            >
              here
            </a>{" "}
            to never miss a{" "}
          ...
          <DropCards artist="assetdash" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
