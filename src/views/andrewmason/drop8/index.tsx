      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop8: <span className="italic">Pool of Rock</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            An aerial photograph over a natural rock pool in Southern California with the photographer lying in the middle as the tide comes in.
            </div>
          </div>
