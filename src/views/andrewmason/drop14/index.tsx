      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop14: <span className="italic">{NFTsInThisDrop[0].name}</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            An aerial photograph over the famous Venice Skatepark in Southern California, USA.
            </div>
          </div>
