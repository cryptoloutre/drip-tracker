      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">Slide</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            Aerial photograph of a parking structure in LA depicting the photographer, Andrew Mason, sliding through the image.
            </div>
          </div>
