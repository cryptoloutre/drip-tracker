      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">Hoop Dreams</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            Aerial photograph of a basketball court along the Pacific Ocean in California by Andrew Mason.
            </div>
          </div>
