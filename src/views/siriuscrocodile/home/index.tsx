...
export const SiriuscrocodileHome: FC = ({}) => {
      ...
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">
            Sirius Crocodile Drop
          </h1>
          <div className="text-center text-3xl font-bold">
            Track the Sirius Crocodile DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Sirius Crocodile is a multi-disciplinary artist and animator. This
            channel is a gateway drug into 1/1 art and blockchain experiments.
            Most commons will be art only but rare and legendary drips may have
            utility in 1/1 art projects. Let’s have some fun with this.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/siriuscrocodile"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/siriuscrocodile"}
            >
              Sirius Crocodile
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://www.siriuscrocodile.com/"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/siriuscrocodile"}
              >
                Instagram
              </a>
            </div>
          ...
          <div className="flex justify-center">
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              <Link
                href="/siriuscrocodile/drop3"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Q-GyqkSjfgrc4qh_La0cKAo8khUMC4bowHEY0UIsWBM?ext=gif"
                    alt="drop 3 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/siriuscrocodile/drop4"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/fM4-ceH38yREcd49E-TNCHYBKcRB-SiWIsCDXQtFR4E?ext=gif"
                    alt="drop 4 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/siriuscrocodile/drop5"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/wVvPA-UMZIb4mdIgtSwBw9UJIMfA5t8mIQQ2KcI4lW0?ext=gif"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/siriuscrocodile/drop6"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Z6lCS6dbu8mxgKxTOS26rTwnAwFjqbg-PTiBC1iIZfw?ext=gif"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/siriuscrocodile/drop8"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/YkM8a_NNLG58iGQ66BF-UquyHpsKApMchmDWuzXuGSo?ext=gif"
                    alt="drop 8 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/siriuscrocodile/drop9"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/1EeCiTfJ9eaDFsjUh6ow-iImEBKMAG9LAEiEKc7LabQ?ext=gif"
                    alt="drop 9 preview"
                  ></img>
                </div>
