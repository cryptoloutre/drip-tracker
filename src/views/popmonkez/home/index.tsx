  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">POPMONKEZ Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the POPMONKEZ DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Sagativa is a self-taught illustrator based in Indonesia.

            His love for cartoon character art encouraged Sagativa to express his creativity through hand drawings of unique monkey characters called popmonkez.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/popmonkez"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/popmonkez"}
            >
              POPMONKEZ
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://lynkfire.com/popmonkez"}
              >
                Website
              </a>
              <a
          ...
          <DropCards artist="popmonkez" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
