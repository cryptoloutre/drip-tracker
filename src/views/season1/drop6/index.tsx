      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Wétiko is a painter and mural artist based out of Detroit,
              Michigan. Wétiko’s first experiment within crypto art is a
              character named Edith.
              <br />
              Edith is the creative output of all the inspiration pulled from
              within the Solana ecosystem. Traditional execution in a digital
              world.
              <br />
              Wétiko painted &quot;Reawaken&quot;, the towering mural{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              Miami, and has created murals for brands like Chrysler, Arcteryx,
            ...
            <div className="sm:w-[70%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-2 mt-4">
              <div className="bg-[#000000] border border-4 border-[#a5a5a5]">
                ...
                {isFetched && (wallet.publicKey || isXNFT) && (
                  <div className="flex justify-center">
                    {isFetched &&
                    userDripNFT.find((nft) => nft == "Edith DRiP") !=
                      undefined ? (
                      <a
                        target="_blank"
                        rel="noreferrer"
              ...
              <div className="bg-[#000000] border border-4 border-t-[#14F195] border-r-[#14F195] border-b-[#9945FF] border-l-[#9945FF]">
                ...
                {isFetched && (wallet.publicKey || isXNFT) && (
                  <div className="flex justify-center">
                    {isFetched &&
                    userDripNFT.find((nft) => nft == "Edith DRiP v2") !=
                      undefined ? (
                      <a
                        target="_blank"
                        rel="noreferrer"
              ...
              <div className="bg-[#000000] border border-4 border-t-[#14F195] border-r-[#14F195] border-b-[#9945FF] border-l-[#9945FF]">
                ...
                {isFetched && (wallet.publicKey || isXNFT) && (
                  <div className="flex justify-center">
                    {isFetched &&
                    userDripNFT.find((nft) => nft == "Edith DRiP v3") !=
                      undefined ? (
                      <a
                        target="_blank"
                        rel="noreferrer"
