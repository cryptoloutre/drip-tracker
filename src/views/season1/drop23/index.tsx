      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop23: <span className="italic">Tarsiers</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/Gossip_Goblin"}
            >
              @Gossip_Goblin
            </a>
          </h1>
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              , has 27+ years of experience creating meticulously detailed
              drawings of goblins, reptiles, and mythical creatures of all
              sorts. <br />
              His work explores our natural history, spanning from Earth&apos;s
              origins to the sobering end of the universe.
              <br />
              He is most well known for creating the art behind the
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/GalacticGeckoSG"}
              >
                @GalacticGeckoSG
              </a>{" "}
              collection, an early and popular{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              created &quot;Tarsiers&quot; a 1/1 PFP collection featuring hand
              drawn characters dressed in Dungeons & Dragons inspired attire.
              From warriors to mages, each Tarsier represents a unique and
              whimsical fantasy archetype.
            </div>
          </div>
          ...
          <div className="md:hero-content flex justify-center gap-2 mt-4">
            <div className="bg-[#000000] w-[150px] sm:w-[300px] border border-4 border-[#a5a5a5]">
              ...
              ></img>
              <h1 className="font-bold mt-2">The Tarsier Viking</h1>
                ...
                <div className="flex justify-center">
                  ...
                  userDripNFT.find((nft) => nft == "The Tarsier Viking") !=
                    ...
                    <a
                      ...
                      href={
                        "https://magiceden.io/marketplace/F8FdDYD3PWndYoae9TrBcucXDWFwDvm6bZU2LQT1PwyB?search=The%2520Tarsier%2520Viking"
                      }
                    >
                      Buy on Magic Eden
                    </a>
            ...
            <div className="bg-[#000000] w-[150px] sm:w-[300px] border border-4 border-[#E6C15A]">
              <img
                className="h-[150px] w-[150px] sm:h-[300px] sm:w-[300px]"
                src="https://shdw-drive.genesysgo.net/52zh6ZjiUQ5UKCwLBwob2k1BC3KF2qhvsE7V4e8g2pmD/The%20Solana%20Sorcerer.png"
              ></img>
              <h1 className="font-bold mt-2">The Solana Sorcerer</h1>
              {isFetched && (wallet.publicKey || isXNFT) && (
                <div className="flex justify-center">
                  {isFetched &&
                  userDripNFT.find((nft) => nft == "The Solana Sorcerer") !=
                    undefined ? (
                    <a
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <a
                      ...
                      className="mt-4 py-2 px-2 font-bold rounded-xl text-xs bg-[#E42575] hover:bg-[#BA2163] uppercase sm:ml-1 mb-2 sm:mb-4"
                      href={
                        "https://magiceden.io/marketplace/F8FdDYD3PWndYoae9TrBcucXDWFwDvm6bZU2LQT1PwyB?search=The%2520Solana%2520Sorcerer"
                      }
                    >
                      Buy on Magic Eden
                    </a>
