      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">Come Back Boomerang</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/Skwidflow"}
            >
              @Skwidflow
            </a>
          </h1>
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              &quot;I&apos;ve been a musician for over 15 years, having played
              bass for local indie bands, and I&apos;ve been producing music for
              the last couple of years. This song is an ode to all the artists,
              collectors, influencers, and anons continuing to make this
              ecosystem thrive.&quot; <br />
              This piece takes influence from funk, jazz, and even french house
              music.
            </div>
          </div>
          ...
          <div className="md:hero-content flex justify-center mt-4">
            <div className="bg-[#000000] border border-4 border-[#a5a5a5]">
              ...
              ></img>
              <h1 className="font-bold mt-2">Come Back Boomerang</h1>
              {isFetched && (wallet.publicKey || isXNFT) && (
                <div className="flex justify-center">
                  {isFetched &&
                  userDripNFT.find((nft) => nft == "Come Back Boomerang") !=
                    undefined ? (
                    <a
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <a
                      ...
                      href={
                        "https://magiceden.io/marketplace/F8FdDYD3PWndYoae9TrBcucXDWFwDvm6bZU2LQT1PwyB?search=Come%2520Back%2520Boomerang"
                      }
                    >
                      Buy on Magic Eden
                    </a>
