      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop9: <span className="italic">Waterfall</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              &quot;A piece created by wiggling a typewriter painting over a
              scanner ever so gently.&quot;
              <br />
              Degen Poet&apos;s signature style combines digital artistry,
              poetry, and an analog typewriter — a vintage Olivetti. Based in
              Chicago, he wrote poetry for 15 years before finding NFTs. <br />
              He is known for some of his remixes and collaborations including:
              Typepunks, Pokemon, Impressions. <br />
          ...
          <div className="md:hero-content flex justify-center mt-4">
            <div className="bg-[#000000] border border-4 border-[#a5a5a5]">
              ...
              ></img>
              <h1 className="font-bold mt-2">Waterfall</h1>
              {isFetched && (wallet.publicKey || isXNFT) && (
                <div className="flex justify-center">
                  {isFetched &&
                  userDripNFT.find((nft) => nft == "Waterfall") != undefined ? (
                    <a
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <a
                      ...
                      href={
                        "https://magiceden.io/marketplace/F8FdDYD3PWndYoae9TrBcucXDWFwDvm6bZU2LQT1PwyB?search=Waterfall"
                      }
                    >
                      Buy on Magic Eden
                    </a>
