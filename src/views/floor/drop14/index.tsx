...
export const Drop14Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 9.5.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 9.5.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            Visa Expands Stablecoin Settlement Pilot to Solana • The Monument Game Declares a Winner • Tensorians Receive Free NFTs as Airdrop
            </div>
