...
export const Drop2Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 6.13.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 6.13.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              SEC Sues Coinbase and Binance • Apple Announces VR Headset Vision
              Pro • Robinhood Delists $SOL
            </div>
