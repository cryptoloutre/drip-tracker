...
export const Drop12Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 8.22.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 8.22.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            Opensea moves to Optional Creator Fees • Degenerate Ape Academy Launches Open Edition on Base • Cets to transition to a DAO
            </div>
