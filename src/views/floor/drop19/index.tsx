...
export const Drop19Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 10.10.2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 10.10.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              DRiP HAUS has Minted Over 50M Collectibles • Famous Fox Federation
              to Enable the Summoning of 2,223 New Foxes • yOOts Holders to
              Begin Migration from Polygon to Eth This Week
            </div>
