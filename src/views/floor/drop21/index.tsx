...
export const Drop21Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 11/7/2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 11/7/2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            Breakpoint 2023 was a Big Success • Jupiter to Airdrop $JUP to 955k Users • Magic Eden Announces Partnership with Yuga Labs
            </div>
