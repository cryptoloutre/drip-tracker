...
export const Drop13Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 8.29.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 8.29.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            DRiP is Halfway to 1 Million Users • Floor Launches Support for Base • Magic Eden Launches a Redesign
            </div>
