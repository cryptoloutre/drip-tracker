...
export const Drop7Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 7.18.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 7.18.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Google Play Changes Policy, Opening Door to NFTs • Larry Fink
              Predicts that Crypto will Transcend Intl Currencies • Judge Rules
              Ripple Sales of XRP Were Not Securities
            </div>
            ...
            <div className="sm:w-[75%] flex items-center grid grid-cols-2 md:grid-cols-2 gap-2 mt-4">
              {NFTsInThisDrop.map((currentNft) => (
                <div key={currentNft.uri} className="flex justify-center">
                  <div
                    className={`bg-[#000000] w-[80%] border border-4 ${
