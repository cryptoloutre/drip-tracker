...
export const Drop20Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 10.24.2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 10.24.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            $SOL Hits New 2023 High • Development Paused on Lotus Gang Collectibles • Degenerate Ape Academy V2 Goes Live
            </div>
