...
export const Drop8Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 7.25.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 7.25.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Floor introduces the platform&apos;s first ever creator series: Floor
              ICONS • Worldcoin launches with a commemorative NFT collectible •
              Opensea launches “Make a Deal” Feature
            </div>
