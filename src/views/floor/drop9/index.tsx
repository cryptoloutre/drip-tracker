...
export const Drop9Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 8.1.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 8.1.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              DRiP HAUS and Stepn Announce Partnership • World of Women Launches
              Patio on Second Anniversary • RENGA Announces Collab with Haas F1
              Team
            </div>
