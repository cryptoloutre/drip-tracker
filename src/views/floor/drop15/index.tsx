...
export const Drop15Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 9.12.2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 9.12.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            Google to Allow NFT Games Ads • Monke DAO Votes to Terminate Gen 3 Team Agreement • Friend.Tech Surpasses $20M TVL
            </div>
