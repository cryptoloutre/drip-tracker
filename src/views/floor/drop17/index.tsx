...
export const Drop17Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 9.26.2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 9.26.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            Magic Eden Launches Open Editions • Floor Launches Support for Zora Network with Free In-App Mint • Backpack Launches DRiP Channel
            </div>
