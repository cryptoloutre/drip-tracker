...
export const Drop11Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 8.15.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 8.15.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            BASE Mainnet has Public Launch • DeGods Launches Season III Art “Downgrade” • Degenerate Ape Academy Celebrates 2 Year Anniversary
            </div>
