...
export const Drop18Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 10.3.2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 10.3.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              $OPOS Launches and Grows to ~$10M FDM • Floor Launches Select Art
              Blocks In-App Mints • $SOL Exceeds $10B Market Cap
            </div>
