      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">{dropDate}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            $JUP to Launch in 4th Week of JUPUARY • Solana Saga Sells Out! • LFG! A Gently Used 2001 Honda Civic!
            </div>
