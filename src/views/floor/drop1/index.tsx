...
export const Drop1Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 6.6.2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 6.6.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[70%] mx-auto">
            ...
            <div>
              Claynosaurz: The Call of Saga mint window goes live • Mad Lads
              crosses 100 SOL floor price for first time EVER • Trade, List, &
              Bid Compressed NFTs on Tensor
            </div>
              ...
              <div key={currentNft.name}>
                ...
                {currentNft.rarity == "Rare" && (
                  <div className="bg-[#000000] border border-4 border-[#E6C15A]">
                    <div className="flex justify-center">
                      <img className="h-[250px]" src={currentNft.image}></img>
                    </div>
                    <h1 className="font-bold mt-2">{currentNft.name}</h1>
                    {isFetched && wallet.publicKey && (
                      <div className="flex justify-center">
