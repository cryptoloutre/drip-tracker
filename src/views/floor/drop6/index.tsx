...
export const Drop6Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 7.11.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 7.11.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            SMB Gen 3 Barrel Raffle Receives Over $30M • Solana 24 Hour NFT Sales Volume Breaks $20M • Phantom Gets a New Ghost
            </div>
