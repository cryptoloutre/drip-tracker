...
export const Drop10Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 8.8.2023";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 8.8.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            Tensor Rewards Season 2 Traders • PayPal Drops Stablecoin $PYUSD • BASE Announces Onchain Summer
            </div>
