...
export const Drop16Floor: FC = ({}) => {
  ...
  const dropDate = "Week of 9.19.2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            <span className="italic">Week of 9.19.2023</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            Magic Eden Now Supports Compressed Solana NFTs • Star Atlas Announces the Launch of SAGE Labs • SEC Charges Creator of Stoner Cats Web Series
            </div>
