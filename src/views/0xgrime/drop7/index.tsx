      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop7: <span className="italic">AWESOME!</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              A repurposing of a demo track titled “Awesome”. The vocals were
              extracted from the original version using AI and a new beat was
              built around the vocals. AI was also used to Master & Enhance the
              track.
            </div>
          </div>
