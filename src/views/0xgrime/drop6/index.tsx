      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">Pesky</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 different collectibles:
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 92617)</span>
              : The first part of The legend of Pesky Penguins
              <br />• The{" "}
              <span className="text-[#E6C15A] font-bold">Rare</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 1027)</span>:
              The second part of The legend of Pesky Penguins
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 112)</span>: A tale as old as time comprising Part 1: NOOT & Part 2: NOOT TALK.
            </div>
          </div>
