      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">MARS</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <br />
              <span className="text-[#a5a5a5] font-bold">MARS - Type A</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 45092)</span>
              : The first Mars experience.
              <br />
              <span className="text-[#a5a5a5] font-bold">MARS - Type B</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 45092)</span>:
              The second Mars experience.
            </div>
          </div>
