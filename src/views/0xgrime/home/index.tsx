  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">0xGrime Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the 0xGrime NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            0xGrime is a vocalist, producer and guitarist who uses NFTs and
            blockchain technology to deliver unique musical experiences, ranging
            from rap to heavy metal and everything in between.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/0x_Grime"}
            >
              0xGrime
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://www.tiktok.com/@0xgrime"}
              >
                TikTok
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/0x_Grime/"}
              >
                Instagram
              </a>
            </div>
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/5maPc7mrxm9gtqZ8MYvNoNuXdM6Au9WoE3sdGH3Z8bU?ext=jpg"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Y19SsV2kDUXSZ_EJP6d1m2kYRJv5oJMkYiSUP2wuZuc?ext=jpg"
                    alt="drop 3 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/AGzyWPK2pRqqDD_SXe-9NBEuyK3OxcYA3NrJ43LT0eo?ext=jpg"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/lMdgvveyNyndfQ4SVdPnSbvS62kcUbeHHjr8a5YjQV8?ext=JPG"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Bo2xv5kS_2AA9cb7V_qMDRYbDgDEXtAERGlCINmqBXE?ext=jpg"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/5YJKQ112hkjGkiRuoTa0BSu_aEY9f7qO9ucyAaEK3Ls?ext=jpg"
                    alt="drop 8 preview"
                  ></img>
                </div>
