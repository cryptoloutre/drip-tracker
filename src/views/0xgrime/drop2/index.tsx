      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">FREEZER</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 59749)</span>
              : The 4th iteration of 0xGrime&apos;s song &quot;FREEZER&quot;. Though complete,
              it may not be the songs final form...
              <br />• The{" "}
              <span className="text-[#E6C15A] font-bold">Rare</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 1000)</span>:
              The 3rd iteration of 0xGrime&apos;s song &quot;FREEZER&quot;. This acted as a demo leading to the 4th iteration of the song.
            </div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[75%] flex items-center grid grid-cols-1 md:grid-cols-2 gap-2 mt-4">
