      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">DeGod</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 different collectibles:
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 108049)</span>
              : 0xGrime&apos;s track &quot;De&quot;, inspired by DeGods. Created using FL Studio.
              <br />• The{" "}
              <span className="text-[#E6C15A] font-bold">Rare</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 1000)</span>:
              Lyric video for 0xGrime&apos;s song &quot;DeRare&quot; with art inspired by the DeGods.
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 100)</span>: DeGods derivative made by 0xGrime, inspired by their S3 drop.
            </div>
          </div>
