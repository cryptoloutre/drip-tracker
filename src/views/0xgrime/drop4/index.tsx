      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">Jeffery The Alien</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              On a hunt for moon rocks, Jeffery took the wrong exit and ended up
              on Earth. Now he vibes with humans, wondering if he&apos;ll ever end up
              back home.
            </div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[75%] flex items-center grid grid-cols-1 md:grid-cols-1 gap-2 mt-4">
