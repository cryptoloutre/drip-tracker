        ...
        <div className="">
          ...
          <div className="flex justify-center">
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              <Link
                href="/picoplay/drop10"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/8c1gBcWUwnfcNXYS1c7uSoFxibOYUpmJsc96T5s_ius?ext=jpg"
                    alt="drop 10 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/picoplay/drop11"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/WF1RSMgeE5rcf_NVPUOg36tfSMR2QnMctraILSpkV3Q?ext=png"
                    alt="drop 11 preview"
                  ></img>
                </div>
