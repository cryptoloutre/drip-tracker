      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">{NFTsInThisDrop[0].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              Boris Spassky, often referred to as &quot;The Match of the
              Century&quot; was a historic Cold War showdown in Reykjavik,
              Iceland. Fischer&apos;s victory made him the first American to win
              the title, ending Spassky&apos;s three-year reign as world
              champion.
            </div>
          </div>
