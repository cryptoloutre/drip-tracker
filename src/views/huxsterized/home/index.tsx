...
export const HuxsterizedHome: FC = ({}) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Huxsterized Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Huxsterized DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Huxster is a photographer and a motion artist from Malaysia.<br/>
            Hux&apos;s pictures place viewers within a world where reality and
            fantasy meet. Made up of striking, minimalist compositions, bursting
            with beautiful colors. Ever on the look-out for bright colours and
            defined lines, Hux reveals the creativity and dynamism you can find
            even in the most unlikely of urban spaces. Hux always tries to make
            ordinary things look extraordinary!
            <br />
            Leica, Apple & FujiFilm Photographer | Adobe Partner
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/huxsterized"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            ...
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/huxsterized/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="huxsterized" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
