...
export const Drop2Huxsterized: FC = ({}) => {
        ...
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 13,6k)</span>
              <br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 8k)</span>
              <br />
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 5k)</span>
            </div>
          </div>
