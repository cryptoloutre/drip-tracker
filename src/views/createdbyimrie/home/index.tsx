...
export const CreatedbyimrieHome: FC = ({ }) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">CreatedbyImrie Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the CreatedbyImrie DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Building the world of Out of Mana every week!
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/createdbyimrie"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/Createdby_imrie"}
            >
              CreatedbyImrie
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/createdbyimrie/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="createdbyimrie" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
