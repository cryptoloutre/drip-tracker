...
export const Drop10MovieSticks: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            1600 pixelated slices of Die Hard (1988), Die Hard 2 (1990), Die Hard with a Vengeance (1995), Live Free or Die Hard (2007) and A Good Day to Die Hard (2013)).
            </div>
          </div>
