...
export const Drop6MovieSticks: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">{NFTsInThisDrop[0].name} & {NFTsInThisDrop[1].name}</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            1600 pixelated slices of It (2017) and It: Chapter Two (2019).
            </div>
          </div>
