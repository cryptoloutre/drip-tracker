      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">sw@rly</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ‘sw@rly’ playfully encapsulates the human behaviour in whimsical
              motion, presented in .glb. These lively figures, swirled into
              dynamic postures, showcase the joy of movement and the emotions in
              life. Like a dance frozen in time, each piece celebrates the fun
              in constant evolution. <br />
              <br />
              This drop features 6 different collectibles:
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span>{" "}
              <span className="italic">sw@rly &apos;jumps & siu!!!&apos;</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 13742)</span>
              .
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span>{" "}
              <span className="italic">sw@rly &apos;lifts and parties&apos;</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 9816)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">sw@rly &apos;breakdance & fall&apos;</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 7852)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">sw@rly &apos;begs & prays&apos;</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 5889)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">sw@rly &apos;tips & poses&apos;</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 1963)</span>.
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">sw@rly &apos;stands & reflects&apos;</span>{" "}
