      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">stroke</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            Algorithmically simulated paint stroke. <br/><br/>
            This drop features 3 different collectibles:
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span>{" "}
              <span className="italic">stroke(white);</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 88697)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">stroke(red);</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 749)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">stroke(black);</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 99)</span>.
            </div>
          </div>
