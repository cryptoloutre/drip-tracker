      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">drape</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            Algorithmically simulated falling satin on breakdancer human motion<br/><br/>
            This drop features 3 different collectibles:
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 76534)</span>
              .
