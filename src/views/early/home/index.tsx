  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Early Art Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Early Art NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Early creates a mix of playful and spooky line and pixel art
            characters and scenes inspired by life down in New Zealand. To get
            creative Early pulls in nostalgic elements from gaming, movies and
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/EarlyArt_sol"}
            >
              Early Art
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://discord.com/invite/DqbGMdKwBw"}
              >
                Discord
              </a>
            </div>
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/VYG4D7sUQly7KO6bawd2Lf3TvkcxBNpLLBZbPzCLtH0?ext=gif"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Wa8e7f4TL0UtM7wD-0Cte9YYY-0iI50LKWxpLvlekpU?ext=gif"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/P6NsEJ1RCIXUx_foyvhSTyrb_-brHJCqaouAxQhpcVY?ext=gif"
                    alt="drop 3 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/8cDI7CTVMWKQ0mHMFjgb5BrGYcQjBbXApP2WqjXgJuo?ext=png"
                    alt="drop 4 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/x99i1U-_OJhQisL_mOzxj78Dl_PpiJ9mUQwn2T-5o4Y?ext=png"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/AdJbrNq7f6M449i2U7zxGAYcQpC8EVFMrc2F8Ebm3GM?ext=gif"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/aaYZUhaopfIlHYRlo7qrfMMEvxYqJjqV6b2yjpd26Ok?ext=png"
                    alt="drop 7 preview"
                  ></img>
                </div>
