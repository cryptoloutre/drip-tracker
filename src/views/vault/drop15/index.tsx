      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop15: <span className="italic">Meccha Samui</span>{" "}
          </h1>
          <div className="mt-12 sm:w-[75%] mx-auto">
            <h2 className="underline text-2xl font-bold">Description</h2>
            <div>
              Unlock the full deluxe live album from {" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://open.spotify.com/artist/3hDJYneesxvXUW0RbShXIE"}
              >
                Meccha Samui
              </a>{" "}
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[30%] w-[100%] flex items-center grid grid-cols-1 gap-2 mt-4">
