      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop7:{" "}
            <span className="italic">The Cave&apos;s “Father (Remix)”</span>{" "}
          </h1>
          <div className="mt-12 sm:w-[75%] mx-auto">
            <h2 className="underline text-2xl font-bold">Description</h2>
            <div>
              Experience the music video to{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/JulianLamadrid_"}
              >
                The Cave
              </a>
              ’s “Father (Remix)”. By unlocking the full music video{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
              ...
              with USDC, you will lock in a legendary DRiP next Monday.
            </div>
          </div>
