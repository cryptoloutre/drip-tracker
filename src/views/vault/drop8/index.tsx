      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop8:{" "}
            <span className="italic">&quot;Baby Ocean Girl&quot; (LIVE)</span>{" "}
          </h1>
          <div className="mt-12 sm:w-[75%] mx-auto">
            ...
            <div>
              ...
              <a
                ...
                href={"https://twitter.com/richiequake"}
              >
                Richie Quake
              </a>
              &apos;s live performance of &quot;Baby Ocean Girl&quot;. Unlock
              more from Richie Quake{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
