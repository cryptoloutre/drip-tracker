      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop22: <span className="italic">{NFTsInThisDrop[0].name}</span>{" "}
          </h1>
          <div className="mt-12 sm:w-[75%] mx-auto">
            <h2 className="underline text-2xl font-bold">Description</h2>
            <div>
            Recorded live at NYC’s Bowery Ballroom. Find their full live album exclusively on {" "}
              <a
                target="_blank"
                rel="noreferrer"
