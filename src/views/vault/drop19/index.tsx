      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop19: <span className="italic">{NFTsInThisDrop[0].name}</span>{" "}
          </h1>
          <div className="mt-12 sm:w-[75%] mx-auto">
            ...
            <div>
              ...
              <a
                ...
                href={"https://www.instagram.com/mynamesurl"}
              >
                url
              </a>
              ’s show Live from NYC’s Sultan Room. More from url coming soon
              on’s show Live from NYC’s Sultan Room. More from url coming soon
              on{" "}
              <a
                target="_blank"
                rel="noreferrer"
