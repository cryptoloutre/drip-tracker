      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">Three Days Live</span>{" "}
          </h1>
          <div className="mt-12 sm:w-[75%] mx-auto">
            <h2 className="underline text-2xl font-bold">Description</h2>
            <div>
              Listen to Sid Simon&apos;s live performance of “Three Days”.
              Unlock more from{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://www.instagram.com/sidsimonsofficial/"}
              >
                Sid Simon&apos;s
              </a>{" "}
