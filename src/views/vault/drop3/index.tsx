      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">“Slot Machine” (LIVE)</span>{" "}
          </h1>
          <div className="mt-12 w-[75%] mx-auto">
            <h2 className="underline text-2xl font-bold">Description</h2>
            <div>
            Listen to Charlotte Rose Benjamin&apos;s live performance of “Slot Machine.” Unlock more from{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://www.instagram.com/charlotterosebenjamin/"}
              >
                Charlotte
              </a>{" "}
