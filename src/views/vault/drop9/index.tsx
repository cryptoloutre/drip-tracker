      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop9:{" "}
            <span className="italic">Chapter 1: &quot;Born To R1S3&quot;</span>{" "}
          </h1>
          <div className="mt-12 sm:w-[75%] mx-auto">
            ...
            <a
              ...
              >Hachi Mugen</a> was BORN TO R1S3. Unlock the first two songs of Hachi Mugen&apos;s 3-song EP on{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[30%] w-[50%] flex items-center grid grid-cols-1 md:grid-cols-1 gap-2 mt-4">
