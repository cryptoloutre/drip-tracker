        ...
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            ...
            <span className="italic">
              {NFTsInThisDrop[0].name}, {NFTsInThisDrop[2].name}, {NFTsInThisDrop[4].name} &{" "}
              {NFTsInThisDrop[6].name}
            </span>{" "}
            by{" "}
            <a
              target="_blank"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 28,7k)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[2].name}</span>.
              {NFTsInThisDrop[2].description}{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 250)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">{NFTsInThisDrop[4].name}</span>.{" "}
              {NFTsInThisDrop[4].description}{" "}
              <span className="text-[#14F195] font-bold">(supply: 35)</span>.
              <br />
              <br />• The{" "}
              <span className="text-[#F94887] font-bold">Ultimate</span>{" "}
              <span className="italic">{NFTsInThisDrop[6].name}</span>.{" "}
              {NFTsInThisDrop[6].description}{" "}
