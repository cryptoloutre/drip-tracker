        ...
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 39522)</span>
              .<br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 125)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 21)</span>.
            </div>
          </div>
