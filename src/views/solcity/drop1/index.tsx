      ...
      <div className="md:hero-content flex">
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              This drop features 4 different collectibles:
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span>{" "}
              <span className="italic">{NFTsInThisDrop[0].name}</span>: “JOM and
              Neverland sat down with Layers to talk seriously among other
              serious matters.”{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 18761)</span>
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">{NFTsInThisDrop[1].name}</span>:
              “Somewhere deep in the Carpathian forests, someone is being lifted
              by an umbrella.” Art by @layers_jpg{" "}
              ...
              <span className="italic">{NFTsInThisDrop[3].name}</span>: “Waiting
              for a falling star.” Art by{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/earlysaint"}
              >
                @earlysaint
              </a>{" "}
              <span className="text-[#14F195] font-bold">(supply: 25)</span>
            </div>
          </div>
