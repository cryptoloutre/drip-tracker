        ...
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#14F195] font-bold">(supply: 13)</span>.
              <br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">{NFTsInThisDrop[3].name}</span>.{" "}
              {NFTsInThisDrop[3].description}{" "}
              <span className="text-[#14F195] font-bold">(supply: 13)</span>.
              <br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              ...
              <span className="italic">{NFTsInThisDrop[5].name}</span>.{" "}
              {NFTsInThisDrop[5].description}{" "}
