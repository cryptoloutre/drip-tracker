...
export const BullyzcrewHome: FC = ({}) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Bullyz Crew Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Bullyz Crew DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Discover the Bullyz Crew and their adventures in these DRip
            exclusive comic strips! Follow Blunderbeard, an exceptionally inept
            captainz that keeps putting his crew in the worst situations. Each
            week, another free comic strip drop to collect.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/bullyzcrew"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/bullyzcrew"}
            >
              Bullyz Crew
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://discord.com/invite/bullyzcrew"}
              >
                Discord
              </a>
            </div>
          ...
          <DropCards artist="bullyzcrew" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
