      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop7: <span className="italic">Creative Observation</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/AllAroundArtsy"}
            >
              @AllAroundArtsy
            </a>
          </h1>
            ...
            <div className="bg-[#000000] border border-4 border-[#a5a5a5]">
              ...
              {isFetched && wallet.publicKey && (
                <div className="flex justify-center">
                  {isFetched &&
                  userDripNFT.find((nft) => nft.name == "Creative Observation") !=
                    undefined ? (
                    <a
                      target="_blank"
                      rel="noreferrer"
                    ...
                    <a
                      ...
                      href={
                        "https://magiceden.io/marketplace/F8FdDYD3PWndYoae9TrBcucXDWFwDvm6bZU2LQT1PwyB?search=Creative%2520Observation"
                      }
                    >
                      Buy on Magic Eden
                    </a>
