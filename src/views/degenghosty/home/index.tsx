...
export const DegenghostyHome: FC = ({ }) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Degen Ghosty Drop</h1>
          ...
          Immerse yourself in Degen Ghosty's world: exclusive comic scripts, melodies, and emotional art for mental health. Join the journey, awaken inspiration.
            ...
            <a
              ...
              href={"https://drip.haus/degenghosty"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            ...
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://bio.site/ghostofinari"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/degenghosty/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="degenghosty" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
