...
export const Drop2Degenghosty: FC = ({ }) => {
  ...
  const dropNb = "No. 2";
  const names = ["The Turning Point 1 of 3", "The Turning Point 2 of 3", "The Turning Point 3 of 3", "The Turning Point- Complete", "The Turning Point Audio", "Rise & Grind"];
        ...
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            ...
            <a
              ...
              href={"https://twitter.com/degenghosty"}
            >
              Degen Ghosty
            </a>
          </h1>
            ...
            <div className="sm:w-[75%] flex items-center grid grid-cols-2 md:grid-cols-3 gap-2 mt-4">
              {NFTsInThisDrop.map((currentNft) => (
                <div key={currentNft.uri} className="flex justify-center">
                  <div
                    className={`bg-[#000000] border border-4 ${currentNft.rarity == "Common" && "border-[#a5a5a5]"
                      } ${currentNft.rarity == "Rare" && "border-[#E6C15A]"} ${currentNft.rarity == "Legendary" &&
