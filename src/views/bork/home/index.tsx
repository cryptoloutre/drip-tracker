            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Ils-SLRg151-9PaLoroeoNguAajJiBZ_UUOk--5YyF0?ext=jpg"
                    alt="chapter 17 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
                  Chapter Seventeen
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/blarpI8r3gidCZnryV2LPyZF8NlT6qfNWLY7riVvTfs?ext=jpg"
                    alt="chapter 19 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
                  Chapter Nineteen
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/JnP3bHuLYprAirC-7xZ3g24yJoKXXnQdUXJjK1RA90w?ext=jpg"
                    alt="chapter 19 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
