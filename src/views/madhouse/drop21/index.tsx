...
export const Drop21Madhouse: FC = ({}) => {
  ...
  const dropNumber = "December 22 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop21: <span className="italic">{NFTsInThisDrop[0].name}, {NFTsInThisDrop[1].name} & {NFTsInThisDrop[2].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            {NFTsInThisDrop[0].description}
              ...
              drop is <span className="italic">{NFTsInThisDrop[3].name}</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 250)</span>
              .
              <br />• The{" "}
