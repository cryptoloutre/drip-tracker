...
export const Drop1Madhouse: FC = ({}) => {
  ...
  const dropNumber = "August 6 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">The Archetypes // Drop 1 of 4</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">
                The Innocent: The Innocent lives in peaceful wonder, often
                oblivious to potential threats.
              </span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 85741)</span>
              .
              ...
              drop is{" "}
              <span className="italic">
                The Explorer: The Explorer seeks knowledge and understanding
                through escape.
              </span>{" "}
              ...
              is{" "}
              <span className="italic">
                The Sage: The Sage desires to unravel life&apos;s mysteries
