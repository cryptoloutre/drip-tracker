...
export const Drop7Madhouse: FC = ({}) => {
  ...
  const dropNumber = "September 17 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop7: <span className="italic">MADbot</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
