...
export const Drop13Madhouse: FC = ({}) => {
  ...
  const dropNumber = "October 27 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop13: <span className="italic">{NFTsInThisDrop[0].name}, {NFTsInThisDrop[1].name} & {NFTsInThisDrop[2].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            {NFTsInThisDrop[0].description}
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 55315)</span>
              .
