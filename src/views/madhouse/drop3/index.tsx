...
export const Drop3Madhouse: FC = ({}) => {
  ...
  const dropNumber = "August 20 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">The Archetypes // Drop 3 of 4</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              The Caregiver: The Caregiver is fulfilled through selfless and generous acts.
              </span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 75051)</span>
              .
              ...
              drop is{" "}
              <span className="italic">
                The Ruler: The Ruler creates order and structure by control.
              </span>{" "}
              ...
              is{" "}
              <span className="italic">
                The Creator: The Creator craves self expression and authenticity.
              </span>{" "}
