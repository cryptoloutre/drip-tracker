...
export const Drop4Madhouse: FC = ({}) => {
  ...
  const dropNumber = "August 27 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">The Archetypes // Drop 4 of 4</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              The Rebel: The Rebel breaks rules for fun and thrives on mayhem.
              </span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 98231)</span>
              .
              ...
              drop is{" "}
              <span className="italic">
                The Hero: The Hero fights for the justice of all.
              </span>{" "}
              ...
              is{" "}
              <span className="italic">
                The Magician: The Magician influences their surroundings with charisma and wit.
              </span>{" "}
