...
export const Drop6Madhouse: FC = ({}) => {
  ...
  const dropNumber = "September 10 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">MADhouse x Maquin</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">The Lab</span>. Maquin Labs was the first
              facility to detect the outbreak of the MADvirus-X. Symptoms for
              this non-lethal virus include the growth of tentacles and warts
              along with excess teeth and eyeballs. Scientists are struggling to
              contain the highly contagious outbreak.
              <span className="text-[#a5a5a5] font-bold">(supply: 70521)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">MADvirus-X 20x</span>. The first specimen of the MADvirus-X shot on a Nikon M200 at 20x zoom.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 750)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">MADvirus-X 100x</span>. The first specimen of the MADvirus-X shot on a Nikon M200 at 100x zoom.{" "}
          ...
          <div className="flex justify-center mt-4">
            <div className="grid sm:w-[70%] grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
