...
export const Drop11Madhouse: FC = ({}) => {
  ...
  const dropNumber = "October 15 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop11: <span className="italic">{NFTsInThisDrop[0].name}, {NFTsInThisDrop[1].name} & {NFTsInThisDrop[2].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            A series of artwork inspired by Wombat&apos;s Soulless collection. The festival is coming.
              <br />
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 77209)</span>
              .
