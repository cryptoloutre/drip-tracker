...
export const Drop2Madhouse: FC = ({}) => {
  ...
  const dropNumber = "August 13 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">The Archetypes // Drop 2 of 4</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              The Everyperson: The Everyperson feels most secure when they blend in to society.
              </span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 57796)</span>
              .
              ...
              drop is{" "}
              <span className="italic">
                The Lover: The Lover craves intimacy and passion to feed their flame.
              </span>{" "}
              ...
              is{" "}
              <span className="italic">
                The Jester: The Jester lives for the moment, never taking life too seriously.
              </span>{" "}
