...
export const Drop5Madhouse: FC = ({}) => {
  ...
  const dropNumber = "September 3 2023";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">MADhouse x My Kids</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
            This week I challenged my 4yo son & 2yo daughter to give me five prompt words and then help me through the design process.<br /><br />
              This drop features 3 rarities:
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span> drop is{" "}
              <span className="italic">
              Inferno Cookie Pig and was created from: Pig, Fire, Cookie, Blue, Square.
              </span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 131965)</span>
              .
              ...
              drop is{" "}
              <span className="italic">
              Captain Carrot Fish and was created from: Fish, Captain, Carrot, Green, Triangle.
              </span>{" "}
              ...
              is{" "}
              <span className="italic">
              Gelato Space Bird and was created from: Bird, Space, Ice Cream, Purple, Circle.
              </span>{" "}
