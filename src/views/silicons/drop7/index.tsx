      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop7: <span className="italic">Trophy #0007</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Congratulations! You got to the final round of TWO:ONE. You hold
              in your possession a token that certifies you can mint a SILICON
              for free on 11 November 2023.
            </div>
          </div>
