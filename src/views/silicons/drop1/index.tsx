      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">Puffer</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              This is the first SILICONS Drip Haus collectible drop. The
              collection is the first of a series of drops we will be doing to
              give you a taste of some cool attributes from the SILICONS
              collection. If you collect 1 more collectible from this weeks drop
              on Tensor, you will receive next weeks sneaker drop. Keep
              collecting 2 of each weeks collectibles, and you will receive
              something really cool before the SILICONS mint.
            </div>
          </div>
