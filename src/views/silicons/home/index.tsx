  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">SILICONS Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the SILICONS DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Silicons is an NFT collection created by CAW Studio.The collection
            has been crafted by industry-leading 3D artists. Fusing fashion,
            culture, and entertainment to create the highest quality collection
            on Solana.
            <br />
            <br />
            Sign up{" "}
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/SILICONS_caw"}
            >
              SILICONS
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/silicons_caw"}
              >
                Instagram
              </a>
            </div>
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/-DeHb5VrfcumpN4-eX2Mo7jL3s14wK_tTIBgeQJZ0hc?ext=png"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/vL_GfJFEuo8hgaiDrM7ADJH1XGoUyqKErvRHbM99MoM?ext=png"
                    alt="drop 2 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/4cNhrlHd21JrMCWRqjLKL-qLwbL6aEzG_4SL4SD3ZbQ?ext=png"
                    alt="drop 3 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/RWsht9_5TnH5FPvy-7wHBW8ynyOjw_E9MM5Y3k5EMrk?ext=png"
                    alt="drop 5 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">Visor #0005</div>
              </Link>
              <Link
                href="/silicons/drop6"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/--bq0ABDXkhJySPJ6K6GqwDR3KIvU2lyjABC_hLxaPo?ext=jpg"
                    alt="drop 6 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">Balaclava #0006</div>
              </Link>
              <Link
                href="/silicons/drop7"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/-y_UcafB56mSpTWrr0SsSLGJJSvp5lljjzWmqS_qZ7M?ext=jpg"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/X8sv7iIFrAY4nZ6APNyh1y9_R5Q_h4GXRz_WXZb_IQI?ext=png"
                    alt="drop 8 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/silicons/drop10"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/qJ8oF7ErDiTzHkRH0sOYljXyL1DTCZndhzeL-earVe8?ext=png"
                    alt="drop 10 preview"
                  ></img>
                </div>
