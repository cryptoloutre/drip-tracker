...
export const Drop3Silicons: FC = ({}) => {
  ...
  const dropNb = "Cargo Shorts #0002";
      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">Shorts</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              This is the third SILICONS Drip Haus collectible drop. Hold 2 of
              each week&apos;s collectibles and you will receive next week&apos;s drop. If
              you get to the end, you will get something really cool before the
              SILICONS mint.
            </div>
          </div>
