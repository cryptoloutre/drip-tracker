      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">Sneaker</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              This is the second SILICONS Drip Haus collectible drop. If you
              collect 2 puffers and 2 sneakers you will receive next week&apos;s
              drop. Keep collecting 2 of each week&apos;s collectibles, and you will
              receive something really cool before the SILICONS mint.
            </div>
          </div>
