...
export const CoolermintHome: FC = ({ }) => {
    ...
    const _userNFTsURI = await Promise.all(
      _userNFTs.map(async (asset) => {
        ...
        if (drop) {
          ...
          drop = attributes.find((nft) => nft.trait_type == "Theme").value;
        }
        return {
          uri,
          drop,
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">coolermint Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the coolermint DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            I am a 3D artist and animator based in London, UK.
            My style could be described as realistic surrealism fuelled with postapocalyptic cyberpunk ghetto ideas, with a lot of attention to devil detail.
            I strive to create work that is clear and uncompromising.
            Creating projects which combine all aspects of 3D work from modelling through sculpting all the way to texturing. Sound effects are my cherry on top.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/coolermint"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/cooler_thanmint"}
            >
              coolermint
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://www.coolerthanmint.com/"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/coolermint/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="coolermint" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
