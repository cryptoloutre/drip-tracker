...
export const Drop1Coolermint: FC = ({}) => {
  ...
  async function getUserNFT() {
    ...
    await Promise.all(
      season2NFT.map(async (asset) => {
        ...
        const drop = attributes.find((nft) => nft.trait_type == "Theme").value;
        if (drop == dropNb) {
        ...
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 32,6k)</span>
              <br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 777)</span>
              <br />
              <br />• The{" "}
