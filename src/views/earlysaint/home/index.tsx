...
export const EarlySaintHome: FC = ({}) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Early Saint Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Early Saint DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Early Saint is a 3D artist who makes animations in black and white.
            Based in Indonesia, they create art related to daily life.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/earlysaint"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            ...
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://earlysaint.carrd.co/"}
              >
                Website
              </a>
              <a
          ...
          <DropCards artist="earlysaint" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
