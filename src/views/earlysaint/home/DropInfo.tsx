export const DropInfo = [
  {
    ...
    NFTs: [
      {
        name: 'More Drip Please !!',
        uri: 'https://arweave.net/WiVLS-kLVI6hSLcgxkAwUsFphc3Qfbd-Q4aYwwR9q5w',
        rarity: 'Common',
        image: 'https://arweave.net/_PlJvTyOU65yqBB0DO-83xTXHin6gtYh6ZamABu6JyU?ext=gif',
        description: 'Wanna more DRip?',
        magicEdenLink: 'https://drip.tensor.trade/trade/drip_earlysaint'
      },
      {
        name: 'Working On',
        uri: 'https://arweave.net/Vh-Tx-Tk909tCNqvnQWL2xaX5QjjIcGUUgoD_65MsSw',
        rarity: 'Rare',
        image: 'https://arweave.net/mjywd_0yJM56Ec6Gx36WrM6gBgaIG3fpdX0Ji6BvwvI?ext=gif',
        description: 'Working on Goodness Stuff',
        magicEdenLink: 'https://drip.tensor.trade/trade/drip_earlysaint'
      },
      {
        name: 'Dripping',
        uri: 'https://arweave.net/pjrJpdfoW3HPI9VwSxAVpsB-762J1QOFs_I6Vd3T86I',
        rarity: 'Legendary',
        image: 'https://arweave.net/KfRqIDL-s6GjkKafAfhLsJyoSScC_OgcF8K6XMmpdcE?ext=gif',
        description: "Processing DRiPping for y'all!!",
        magicEdenLink: 'https://drip.tensor.trade/trade/drip_earlysaint'
      }
    ],
  },
