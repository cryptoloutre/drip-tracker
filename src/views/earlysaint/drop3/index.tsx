...
export const Drop3EarlySaint: FC = ({}) => {
        ...
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 39.4k)</span>
              <br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 456)</span>
              <br />
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 69)</span>
            </div>
          </div>
