  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">0xGRAFFITO Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the 0xGRAFFITO DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Venture into the realm of 0xGRAFFITO (Jackie Singh), where the art
            of hacking and digital creativity collide.
            <br />
            Witness as GRAFFITO engages in an artistic exploration of privacy,
            surveillance, and technology, revealing the depth of a native
            hacker&apos;s inner landscape. Experience her unique vision. Gain
            insight to a world not your own. GRAFFITO.
            <br />
            1 droplet = 1 emotion.
            <br />
            <br />
            ...
            <a
              ...
              href={"https://drip.haus/0xgraffito"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/0xGRAFFITO"}
            >
              0xGRAFFITO
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://graffito.webflow.io/"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://exchange.art/graffito/exhibition"}
              >
                Exchange Art
              </a>
            </div>
          ...
          <DropCards artist="0xgraffito" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
