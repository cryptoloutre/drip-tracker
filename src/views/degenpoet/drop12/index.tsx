      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop12:{" "}
            <span className="italic">Phantom, AWAG & Drip Too Hard</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Type Phantom</span>. A group of
              Typewriter versions of Phantom&apos;s new logo. The centerpiece
              depicts San Francisco, CA, where Phantom&apos;s home office is
              located. Created with watercolor pencils and a Royal Classic
              Typewriter.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 262405)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">AWAG Sprint</span>. An animated
              GIF created by Ain&apos;t We All Gods, typed over with an
              Underwood Quiet Tab typewriter by Degen Poet and scanned. 10
              individually typed frames.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Drip Too Hard</span>. Animated GIF
              based on the album cover for “Drip Too Hard” by Gunna and Lil
              Baby. Created with an Underwood Quiet Tab typewriter & watercolor
              paint splatter.{" "}
