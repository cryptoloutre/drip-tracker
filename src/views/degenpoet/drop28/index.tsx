        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">{NFTsInThisDrop[0].name}</span>. Inspired
              by the first Degen Poet piece ever dripped, “Waterfall”. Stamps,
              marker, and typewriter.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 504094)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[1].name}</span>.
              Based on the DRiP genesis, “Agility”, created by Vincenzo.
              Photoshopped & printed the original piece, typed on top with an
              Underwood Quiet Tab typewriter and scanned.{" "}
              ...
              Spaceman made out of watercolors & typewriter. Based on the DRiP
              Season 1 “Spaceman” by Bunjil.{" "}
