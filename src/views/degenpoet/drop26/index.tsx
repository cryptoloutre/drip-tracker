        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">{NFTsInThisDrop[0].name}</span>. Inside
              you there are two horses. Oil pastels on sketch paper, scanned.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 523639)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[1].name}</span>.
              Driving down Dempster Street during sunset. Oil pastels on sketch
              paper, scanned.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">{NFTsInThisDrop[2].name}</span>. A guy
              opening a bottle of champagne with a knife. Oil pastels on sketch
              paper, scanned.{" "}
