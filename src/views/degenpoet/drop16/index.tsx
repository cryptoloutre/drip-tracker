        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            ...
            <span className="italic">
              The Wind Is Me, Joyhog Devil & Utopia
            </span>{" "}
            by{" "}
            <a
              target="_blank"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">The Wind Is Me</span>. A poem by Degen
              Poet typed on an Olympia Splendid 33 typewriter with a cursive
              font.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 290382)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Joyhog Devil</span>. A
              collaboration with Joyhog. A typewriter illustration and an oil
              pastel painting, scanned & layered on top of each other in
              Photoshop.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Utopia</span>. A typewriter and oil
              pastel illustration based on an alternate cover of Travis
              Scott&apos;s Utopia.{" "}
