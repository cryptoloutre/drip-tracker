      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop17:{" "}
            <span className="italic">Freepoet, Basket Monke & Type Ghost</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Freepoet</span>. A bird escaping a cage.
              The first drop since Degen Poet lost his twitter account & was
              renamed to @solanapoet. Typewriter and oil pastels on paper.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 348698)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Basket Monke</span>. A tribute to
              21 DAO, a non-profit group that supports Solana artists. Original
              monke design by Basket. Typewriter, oil pastel, and scanning
              effects.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Type Ghost</span>. A typewriter and
              oil pastel illustration based on Degen Poet&apos;s forever
              GhostKid #1986.{" "}
