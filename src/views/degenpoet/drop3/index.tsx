      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">Dream</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              A flurry of poems buried in abstract type & swipes of ink. Royal
              Classic Typewriter + Alphabet stamps.
              <br />
              <br />
              This drop features 3 rarities:
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span> drop is{" "}
              <span className="italic">The Lonely Dream</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 89073)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">The Beginning of a Dream</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 5000)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">The Bloody Dream</span>{" "}
