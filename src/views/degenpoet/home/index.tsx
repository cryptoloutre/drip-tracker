        ...
        <div className="">
          ...
          <div className="flex justify-center">
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              <Link
                href="/degenpoet/drop37"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/IwuG3B840-ToXfudF_7EBT-moYi8DK8KGSTwmDMZucY?ext=jpg"
                    alt="drop 37 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">DROP 37</div>
              </Link>
              <Link
                href="/degenpoet/drop38"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Jt_tHs9MgNHF5glWDa7xYzXuLV2mJMK7hH96GIUmf6Q?ext=gif"
                    alt="drop 38 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">DROP 38</div>
              </Link>
              <Link
                href="/degenpoet/drop39"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/9uw_U24kGgsiBb4V7KdakztYqhDwZoUV5ynRbzq7y9A?ext=jpg"
                    alt="drop 39 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">DROP 39</div>
              </Link>
              <Link
                href="/degenpoet/drop40"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/sFjKGoCvXA3DTsYH0VdruN58HHejsxPHZ0pw54Qw0cQ?ext=jpg"
                    alt="drop 40 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">DROP 40</div>
              </Link>
            </div>
          </div>
        </div>
