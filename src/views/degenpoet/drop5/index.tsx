      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">Ape</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[70%] mx-auto">
            ...
            <div>
              Animation by Degen Poet created using an Underwood Quiet Tab
              typewriter, oil pastels, and scanner. Inspired by Degen Ape #8453.
              & a pink scene of a Degen Ape smoking in a city street. Created by
              Degen Poet with a typewriter. Based on a scene drawn by Degen Ape
              Academy.
              <br />
              <br />
              ...
              <span className="italic">Bubblegum Ape</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 132041)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Midnight Ape</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 7500)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Viva Sweet Spring</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 1500)</span>.
            </div>
          </div>
