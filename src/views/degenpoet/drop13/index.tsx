      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop13: <span className="italic">Firewroks, Saturn & Lily</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Fireworks</span>. A hand drawn animation
              set to the sounds of fireworks recorded near Degen Poet&apos;s
              home.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 302580)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Type Saturn</span>. A
              three-dimensional portrait of planet Saturn created with a Hermes
              Media 3 typewriter and photoshop.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Water Lily</span>. A Lily created with
              watercolor pencils and black ink pen. Based on Degen Poet&apos;s
              forever Lily #7170.{" "}
