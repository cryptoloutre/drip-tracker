      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop10: <span className="italic">Self-Portrait, Jakey & Raccs</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Self-Portrait</span>. A portrait of Sol
              Jakey based on selfies he takes everyday until SOL reaches an ATH.
              It looks a lot like Degen Poet without glasses. We are all one.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 172343)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Sky Jakey</span>. An animated GIF
              of Sol Jakey skydiving. Based on a clip from Mad Movie 2. Created
              with oil pastels & Underwood Quiet Tab Typewriter{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 9167)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Type Raccs</span>. Animated GIF of
              Degen Poet&apos;s forever Raccs #2598. Created with oil pastels &
              Underwood Quiet Tab Typewriter.{" "}
              <span className="text-[#14F195] font-bold">(supply: 2293)</span>.
            </div>
          </div>
