        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            ...
            <span className="italic">
              Wish You Were Here, Bastard Oogy & Planet Atlas
            </span>{" "}
            by{" "}
            <a
              target="_blank"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Wish You Were Here</span>. Nostalgia for
              the good times. An illustration created with an Underwood Quiet
              Tab Typewriter.{" "}
              ...
              drop is <span className="italic">Bastard Oogy</span>. A typewriter
              illustration based on the infamous Oogy x Bastards bar scene.
              Created during the rush of both projects minting at the same time.
              A good luck charm.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Planet Atlas</span>. A scene from the
              Universe of Star Atlas. The intersection of ships, seas, and
              planets. Created with a Royal Classic Typewriter and oil pastels.{" "}
