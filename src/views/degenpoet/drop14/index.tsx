        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            ...
            <span className="italic">
              Moment of Moonlight, Type Kombat & DRiP God
            </span>{" "}
            by{" "}
            <a
              target="_blank"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Moment of Moonlight</span>. A typestract
              created with watercolor, stamps, and a Royal Classic Typewriter.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 351666)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Type Kombat</span>. A fight
              between the letter “S” and “G”, based on Mortal Kombat. Created
              with 20 individually typed frames.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">DRiP God</span>. A God created with an
              Underwood Quiet Tab typewriter and photoshop. Based on Degen
              Poet&apos;s forever God #4730.{" "}
