      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop7: <span className="italic">Disco</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[70%] mx-auto">
            ...
            <div>
              Animated GIFs created with markers and an Underwood Quiet Tab typewriter.
              <br />
              <br />
              This drop features 3 rarities:
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span> drop is{" "}
              <span className="italic">Disco Ball</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 171132)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Saturday Night Fever</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 9102)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Type Lassie</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 1820)</span>.
            </div>
          </div>
