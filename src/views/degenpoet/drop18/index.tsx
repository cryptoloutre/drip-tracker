      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop18:{" "}
            <span className="italic">We Love Utility, Snooby & Typesorian</span>{" "}
            by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">We Love Utility</span>. A painting
              created with a Royal Classic Typewriter, featuring a poem from a
              Vibhu tweet. Image based on “Skiffs” by Gustave Caillebotte, 1877.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 289603)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Snooby</span>. A collaboration
              with Sobana Paint. A cool version of Snooby created with a Royal
              Classic Typewriter with no letter “E” key.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Typesorian</span>. A Tensorian
              animation created with a typewriter and oil pastels. Based on
              Degen Poet&apos;s Tensorian #8354.{" "}
