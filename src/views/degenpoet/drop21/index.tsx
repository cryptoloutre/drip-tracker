      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop21:{" "}
            <span className="italic">Armani Pull-Ups, Doodle Devil & Zombie Chad</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Armani Pull-Ups</span>. Armani doing pull-ups for Mad Lads. Made with a Hermes typewriter scan subtracted over an oil pastel painting.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 374043)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Doodle Devil</span>. A typewritten Doodle Devil cut out of a piece of paper. Based on Degen Poet’s forever DD #309.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Zombie Chad</span>. A half-zombie, half-cyborg Chad. Made with a Hermes typewriter and red sharpie.{" "}
