      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">Mad Lad</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[70%] mx-auto">
            ...
            <div>
              This drop is based on Degen Poet&apos;s forever{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://twitter.com/MadLadsNFT"}
              >
                @MadLadsNFT
              </a>{" "}
              #3533.
              ...
              <span className="italic">Poet Lad, a Mad Lad created with a Hermes Media 3 typewriter & oil pastels</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 69172)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Type Lad, a Mad Lad created with a Hermes Media 3 typewriter</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 3000)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Pastel Lad, a Mad Lad created with oil pastels</span>{" "}
              <span className="text-[#14F195] font-bold">(supply: 1000)</span>.
            </div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="grid w-[70%] grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
