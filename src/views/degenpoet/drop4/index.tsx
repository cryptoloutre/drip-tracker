      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">Nacho</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[70%] mx-auto">
            ...
            <div>
              Artwork and animations created using an Underwood Quiet Tab
              typewriter, chalk ink markers, scanner, and photoshop inspired from the movie Nacho Libre.
              <br />
              <br />
              This drop features 3 rarities:
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span> drop is{" "}
              <span className="italic">Nacho Smile</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 109763)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Nacho Type</span>{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 5000)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Nacho Lunge</span>{" "}
