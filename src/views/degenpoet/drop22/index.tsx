      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop22:{" "}
            <span className="italic">Hyperbot, Sky Robots & Hyperdrive</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Hyperbot</span>. A Solana robot charging up for the Hyperdrive Hackathon. Created with a Hermes typewriter and oil pastels.A Solana robot charging up for the Hyperdrive Hackathon. Created with a Hermes typewriter and oil pastels.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 299240)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Sky Robots</span>. A collaboration with Xoo Chi. Digital image by Xoo photoshopped, printed out, and typed on by Degen Poet with a Royal Classic typewriter.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Hyperdrive</span>. A robot DP-430, named after Degen Poet&apos;s birthday April 30th, escaping to hyperspace with a Degen Ape copilot. Created in honor of Solana&apos;s Hyperdrive Hackathon. 16 frames of Hermes typewriter animation.{" "}
