  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Bunjil Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Bunjil DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Weekly sketches and thoughts.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/notbunjil_"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="bunjil" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
