  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">BECC Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the BECC DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Becc is a Video Creator based on Solana.

            Becc is passionate about entertainment, education, and fun through content.

            Good vibes only. Let&apos;s Ball.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/URBROBECC"}
            >
              BECC
            </a>{" "}
            DRiP drop.
          ...
          <DropCards artist="becc" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
