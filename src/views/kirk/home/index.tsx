  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Kirk Englehardt Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Kirk Englehardt DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Kirk Englehardt doesn’t just take photos, he tells stories. It’s the art of authenticity and his lens finds narratives in the nuances that most might overlook.<br />

            Driven by curiosity and emotion, he follows his instincts, exploring the world with wide-eyed wonder. His creations are incredibly honest visual explorations of life.<br />

            Through his weekly DRiPs, you’ll experience the raw, riveting power of visual storytelling, where every shot is a story and every moment Kirk captures is an opportunity to see the world in a new light.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/kirkenglehardt"}
            >
              Kirk Englehardt
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://linktr.ee/KirkEnglehardt"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.solarplex.xyz/profile/kenglehardt.live.solarplex.xyz"}
              >
                Solarplex
              </a>
            </div>
          ...
          <DropCards artist="kirk" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
