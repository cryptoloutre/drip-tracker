...
export const Drop4DropNation: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">Mike Epsse</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              dance-floor ready techno house banger by Mike Epsse brings the
              ENERGY! Get ready to shuffle those feet! KEEP ON is the first song
              in Mike Epsse&apos;s debut 3-song DRiP on Drop Nation!{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 30037)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[1].name}</span>.
              A euphoric and nostalgic masterpiece by Mike Epsse that will have
              you listening again and again! This song will hit you in the feels
              and get you dancing at the same time! TIMES WE SHARED is the
              second song in Mike Epsse&apos;s debut 3-song DRiP on Drop Nation!{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">{NFTsInThisDrop[2].name}</span>. An IN
              YOUR FACE bass house banger by the legendary DJ and producer Mike
              Epsse! TONIGHT is a song that every DJ should have in their
              library! TONIGHT is the third song in Mike Epsse&apos;s debut
