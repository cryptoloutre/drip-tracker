...
export const DropNationHome: FC = ({}) => {
      ...
      <div className="md:hero-content flex justify-center">
        <div className="">
          ...
          <div className="text-center text-3xl font-bold">
            Track the Drop Nation 💧 DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Sit back, turn up the volume, and feel the bass!
            <br />
            <br />
            ...
            <a
              ...
              href={"https://drip.haus/dropnation"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/dropnationsol"}
            >
              Drop Nation
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://www.youtube.com/@officialdropnation"}
              >
                Youtube
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://discord.com/invite/dropnation"}
              >
                Discord
              </a>
            </div>
          ...
          <div className="flex justify-center">
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              <Link
                href="/dropnation/drop1"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Rzbs8q5ieyJzc3_T-iLGX6ZKCvcDT0zC1rA1hG3TLuo?ext=jpg"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop2"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Nu-kKnrLeIcAAZaLCM6wMb9NQ-KA4s9WNXWPOvqRfYY?ext=jpg"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/KpkOBxtURi_UdZ3Zbr0QHTL-UDbNbCciaEpA_ySs_Vk?ext=jpg"
                    alt="drop 3 preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">
              ...
              <Link
                href="/dropnation/drop6"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/YbXMoj6b3gpnlJzJ68hC718yRHlDSbhUFR8RZKLeDfI?ext=jpg"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop7"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/2IFeMKb1I5i4UloXrVq6m11h8si-Qa3NhfnGCarVlPw?ext=jpg"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop8"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/u9XqXOWEgWPOliPhJ81FPPonaaLDm9ywj2_Gr5r4fno?ext=jpg"
                    alt="drop 8 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop9"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/gbLpTfkKhXAty_MtqT-aTbCqRzX-Blj0Tjd05U4OkTs?ext=jpg"
                    alt="drop 9 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop10"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/SK25IdZTkop6RdKUgr9BcPUwdnb73XbT5OvlxIJxgFE?ext=jpg"
                    alt="drop 10 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop11"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/v1u_jGFXpmwvP1pcT6YkQYun3-UsQc9jNFVD25Wymf4?ext=jpg"
                    alt="drop 11 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop12"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/o3agmGjWSq2LlyS9H51w4FuiKOUWKBxexpOzZcCnWHY?ext=jpg"
                    alt="drop 12 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop13"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/4ZiZPgjKRY0UMCL7xvJOE1LYLOe26CWFb-0tgNYa7Ic?ext=jpg"
                    alt="drop 13 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop14"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/JuVGDZnDqisItq8QEBvCOH2KGAWRZgPOrsH2mhuTGDw?ext=jpg"
                    alt="drop 14 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop16"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/bdZ5fQgU0cXlBwzVWyETz52OrdDqWFUTTjWaCZeztSY?ext=jpg"
                    alt="drop 16 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop17"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/s58ezslnVgjyhI3g1MW4MJwHlzzmrLuzVmK4V8dSQ0Y?ext=jpg"
                    alt="drop 17 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop18"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/S2TMdEti-yGra0EBKqcRnwXSngvKTA9GYm7UWFV6OQk?ext=jpg"
                    alt="drop 18 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop19"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/FF3kRvtMGpqvpvtS1jrKkl9PjFQEb_GedzWLPG2UKSk?ext=jpg"
                    alt="drop 19 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/dropnation/drop20"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/abaVwUvhaKxKcEWSGnVtRK0cqEniYTmH2Wx5UjJrTdQ?ext=jpg"
                    alt="drop 20 preview"
                  ></img>
                </div>
