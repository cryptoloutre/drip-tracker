...
export const Drop5DropNation: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">Vitamin THC #2</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              mesmerizing vocal-centric big room house anthem by Vitamin THC
              brings the HEAT🔥! We can tell you&apos;ll feel the same! IN YOUR
              EYES is the first song in Vitamin THC&apos;s 2nd 3-song DRiP on
              Drop Nation💧!{" "}
              ...
              This euphoric bass-heavy vocal anthem by Vitamin THC will have you
              dancing at the club deep into the night✨! THE NIGHT is the second
              song in Vitamin THC&apos;s 2nd 3-song DRiP on Drop Nation💧!{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">{NFTsInThisDrop[2].name}</span>. This
              emotion-driven future house tune by Vitamin THC will have you
              singing along and banging your head! SLiP AWAY is the third song
              in Vitamin THC&apos;s 2nd 3-song DRiP on Drop Nation💧!{" "}
