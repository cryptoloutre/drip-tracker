...
export const Drop3DropNation: FC = ({}) => {
  ...
  const dropNumber = "Palm Tree Gang";
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">Palm Tree Gang</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">{NFTsInThisDrop[0].name}</span>. This
              hard-hitting industrial midtempo banger by the Palm Tree Gang
              brings the HYPE! Get your hand&pos;s up and prepare yourself for
              the DROP! DROP is the first song in Palm Tree Gang&apos;s debut
              3-song DRiP on Drop Nation💧!{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 27887)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[1].name}</span>.
              A melodic, nostalgic, and euphoric dubstep banger by the Palm Tree
              Gang! Let&apos;s BRING THE HOUSE DOWN! EARTHQUAKE is the second
              song in Palm Tree Gang&pos;s debut 3-song DRiP on Drop Nation💧!{" "}
              ...
              melodic crescendo of synthesizers and catchy vocals swirl into the
              Palm Tree Gang&apos;s notorious heavy bass drops in this monstrous
              dubstep track! The Palm Tree Gang is notorious for their unique
              mind-bending sound! COME WITH ME is the third song in Palm Tree
              Gang&apos;s debut 3-song DRiP on Drop Nation💧!{" "}
