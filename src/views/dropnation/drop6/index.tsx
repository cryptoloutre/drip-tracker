...
export const Drop6DropNation: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">RXE</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              beautiful high-energy house music anthem by RXE is going to hype
              you up and TAKE YOU DOWN🔥! Turn it up! TAKE YOU DOWN is the first
              song in RXE&apos;s 3-song DRiP on Drop Nation💧!{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 34930)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[1].name}</span>.
              A euphoric, airy, uplifting, and hard-hitting house song by top
              female DJ/producer RXE that will leave you wanting more and more!
              🎵🔥 TAKE ME is the second song in RXE&apos;s debut 3-song DRiP on
              Drop Nation💧!{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2000)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">{NFTsInThisDrop[2].name}</span>. There
              are almost no words to describe this masterpiece hit-song by the
              legendary female DJ/producer RXE!❤️👑 The queen of house music
              cements her spot on the throne with this unbelievably catchy
              banger!🎵 SHOW ME HOW is the third song in RXE&apos;s debut 3-song
              DRiP on Drop Nation💧!{" "}
