...
export const Drop1DropNation: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">Vitamin THC</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">RIGHT HERE RIGHT NOW</span>. This
              bass-line driven tech house banger is the perfect song for any
              occasion! Let&apos;s get this party started! The first song in
              Vitamin THC&apos;s debut 3-song DRiP on Drop Nation💧!{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 11787)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">SAVE</span>. This hypnotic tech
              house tune by Vitamin THC speaks for itself! Keep the party
              goin&apos;! The second song in Vitamin THC&apos;s debut 3-song
              DRiP on Drop Nation💧!{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 1500)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">EVERYTHING</span>. You got everything
              I want, I got everything you need! This party train never stops!
              The third song in Vitamin THC&apos;s debut 3-song DRiP on Drop
              Nation💧!{" "}
