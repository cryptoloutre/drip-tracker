...
export const Drop2DropNation: FC = ({}) => {
    ...
    await Promise.all(
      season2NFT.map(async (asset) => {
        ...
        const drop = attributes
          .find((nft) => nft.trait_type == "Artist")
          .value.trim();
        console.log(drop);
        if (drop == dropNumber) {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">QRTX</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Fire Cannon</span>. This incredibly hard
              EDM banger is going to melt your brain, literally! Prepare
              yourself for a journey into the realm of fire! Fire Cannon is the
              first song in QRTX&apos;s debut 3-song DRiP on Drop Nation💧!{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 21656)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Rituals</span>. This psychedelic
              masterpiece by QRTX will take you on a spiritual journey like
              you&apos;ve never experienced before! Drawing influence&apos;s
              from a far away world; it will wipe away all your thoughts like a
              mental squeegee! Rituals is the second song in QRTX&apos;s debut
              3-song DRiP on Drop Nation💧!{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 1500)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Curcuma</span>. This incredibly
              energetic and unique EDM banger by QRTX will put you in a trance,
              have you bangin&apos; your head, and dancing like you&apos;ve
              never danced before! Curcuma also known as Turmeric is considered
              the golden spice of India and this track certainly represents the
              flavor fully! 💥! Curcuma is the third song in QRTX&apos;s debut
              3-song DRiP on Drop Nation💧!{" "}
              <span className="text-[#14F195] font-bold">(supply: 250)</span>.
            </div>
          </div>
