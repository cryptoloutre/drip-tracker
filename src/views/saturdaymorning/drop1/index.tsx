...
export const Drop1Saturdaymorning: FC = ({}) => {
        ...
        <div className="">
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 89637)</span>
              .<br />
              ...
              <span className="text-[#14F195] font-bold">(supply: 150)</span>.
            </div>
          </div>
