            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/v3iLS-Y9cEIf0fLmPJHiugrOV3b1ZN9BbMIiWayL_5Q?ext=jpg"
                    alt="drop 11 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/OmwQDGtckiV0uLihFQ_RTdrVvdLco73PqjXHBgG_ioA?ext=jpg"
                    alt="drop 12 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/kUy4vf6ftSISV74MSILGJ1QABVNqZKROvihxBrvOh2k?ext=jpg"
                    alt="drop 13 preview"
                  ></img>
                </div>
