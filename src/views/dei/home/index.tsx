  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Postmodern Ouroboros Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Postmodern Ouroboros DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Postmodern Ouroboros is a pixel artist and game designer based in Venezuela.
            Through glitched and grimdark compositions, Postmodern Ouroboros explores the vast field of storytelling using minimalism,
            neotribal and game UI design as inspirations and pixel art as medium for his stories and thoughts.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/Dei_Septentrion"}
            >
            ...
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://bento.me/deiseptentrion"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/dei_septentrion/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="dei" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
