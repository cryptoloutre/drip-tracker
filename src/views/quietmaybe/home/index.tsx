...
export const QuietMaybeHome: FC = ({}) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">quietmaybe Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the quietmaybe DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Travis, aka quietmaybe, is an abstract artist who mixes traditional
            and digital styles. His art is his escape from anxiety, a moment of
            peace in his busy mind. He shares his thoughts through weekly art
            drops, connecting his world with yours.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/quietmaybe"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/quietmaybe"}
            >
              quietmaybe
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/quietmaybe/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="quietmaybe" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
