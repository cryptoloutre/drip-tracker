      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">Path to the Mountains, Urban Luminance & Twilight&apos;s Guardian</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 rarities:
              ...
              <span className="italic">Path to the Mountains</span>. Photograph of the iconic Mount Cook from the Hooker Valley track.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 40049)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Urban Luminance</span>. A long exposure photograph of the winding motorways in central Auckland, New Zealand.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 1500)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Twilight&apos;s Guardian</span>. Photograph of the Church of the Good Shepherd in New Zealand.{" "}
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[70%] w-[100%] flex items-center grid grid-cols-2 md:grid-cols-3 gap-2 mt-4">
