      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">Cut of Light, Slice of Hue & Skyline Spectrum</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 rarities:
              ...
              <span className="italic">Cut of Light</span>. A time layered photograph featuring Radiant&apos;s tag.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 31263)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Slice of Hue</span>. A time layered photograph featuring the Sky Tower.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 1500)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Skyline Spectrum</span>. A wide time layered panorama showcasing the Auckland skyline.{" "}
