        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">{NFTsInThisDrop[0].name}</span>. A wide
              time layered panorama of the sunset over the city{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 43292)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[1].name}</span>.
              A wide time layered panorama of the sunset over the city{" "}
              ...
              time layered photograph of the sunset over the city, edited as a
              starburst from the Sky Tower{" "}
