        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              It&apos;s a good time to set, clear our heads, and rev up for a
              fresh kickstart.{" "}
              ...
              <span className="italic">{NFTsInThisDrop[1].name}</span>: Is it
              good to keep fallin&apos;? Then fall with style!{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 500)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">{NFTsInThisDrop[2].name}</span>: Honor
              means the world. Chances might not roll around twice, but hey, you
              took your shot. Because nothing is worthless.{" "}
