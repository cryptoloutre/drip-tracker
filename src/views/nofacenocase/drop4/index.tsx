      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">Through these eyes, Rituals & Buckwild</span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 different collectibles:
              ...
              <span className="italic">Through these eyes</span>{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 73044)</span>
              .
              ...
              <span className="italic">Buckwild</span>{" "}
