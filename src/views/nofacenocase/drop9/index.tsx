        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">{NFTsInThisDrop[0].name}</span>: A true sneakerhead. Burner is always on the hunt for the latest and greatest.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 82277)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">{NFTsInThisDrop[1].name}</span>: Secured the new drop!{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 500)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">{NFTsInThisDrop[2].name}</span>: Everyone wanna be like Mike.{" "}
