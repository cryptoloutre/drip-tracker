      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop7: <span className="italic">The Dynamic Duo, Midnight Snack & The WPG</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">The Dynamic Duo</span>: Partners + Loyalty = The DD{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 72924)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">Midnight Snack</span>: Stay hungry...even in the middle of the night{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 500)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">The WPG</span>: Are you down with The WPG?{" "}
