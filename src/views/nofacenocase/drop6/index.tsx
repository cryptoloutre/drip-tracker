      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">EMBER, TUBER & LOTSO</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">EMBER</span>: Used to be human, but was
              cursed by an evil witch. Innocent but deadly.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 98764)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">TUBER</span>: Taken by tuberculosis, been
              coughing chronically because his home was caught in wildfire,
              burnt by greedy humans, yet he still eager to live.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 500)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">LOTSO</span>: Inspired from toy story
              character, he&apos;s old, but being cute is mandatory.{" "}
