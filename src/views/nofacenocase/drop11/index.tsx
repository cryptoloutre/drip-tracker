        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">{NFTsInThisDrop[0].name}</span>: Rev, I
              do cool stuff, trust me :D (don&apos;t forget the emoji){" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 119144)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              <span className="italic">{NFTsInThisDrop[1].name}</span>: 50%
              Pixels 40% Lines 10% Smoke, 100% Schizophrenic.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 500)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span>{" "}
              <span className="italic">{NFTsInThisDrop[2].name}</span>: Skating
              is hard man, but GOD told me to skate on the surface of the moon,
              it&apos;s a little bit easier you know, we FLOAT!!!{" "}
