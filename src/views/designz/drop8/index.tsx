      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Acrylic On Paper/Digital Edit. Painted using a butterfly knife,
              index cards & an unsharpened pencil.
              <br />
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 88480)</span>
              .<br />
