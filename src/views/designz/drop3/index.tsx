      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            ...
            Flashback, Space-Time Infatuation & Platinum Mindset
            </span>{" "}
            by{" "}
            <a
              target="_blank"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Flashback</span>. 2 paintings blended with palette knives, paper, pencil erasers, acrylic & digitally mirrored.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 100012)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Space-Time Infatuation</span>.
              2 paintings blended with pallet, knives, paper, brushes, acrylic & digitally mirrored.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 750)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Platinum Mindset</span>. 2 paintings blended with pallet knives, paper, chef knives, acrylic & digitally mirrored.{" "}
