      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            ...
            Parts Of Me, I See Everything & I Am Machine
            </span>{" "}
            by{" "}
            <a
              target="_blank"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Parts Of Me</span>. Hand painted with acrylic & oil on paper using brushes & pallet knives. Abstract art inspired by robots, for DRiP&apos;s Robots Week.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 40682)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">I See Everything</span>.
              Hand painted with acrylic & oil using brushes, pallet knives & marker. Abstract art inspired by robots, for DRiP&apos;s Robots Week.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 750)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">I Am Machine</span>. Hand painted with acrylic & oil using brushes, pallet knives & marker. Abstract art inspired by robots, for DRiP&apos;s Robots Week.{" "}
