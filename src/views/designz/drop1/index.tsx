        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            ...
            <span className="italic">
              Disintegrated Minds, Walking Toward the Future & Looking to the
              Past
            </span>{" "}
            by{" "}
            <a
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">Disintegrated Minds</span>. Two physical
              paintings layered together, causing the colors to invert before
              framing.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 36035)</span>
              .<br />
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">Walking Toward the Future</span>.
              Physical Acrylic on paper with pallet knives & the wrong end of a
              paint brush.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 750)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">Looking to the Past</span>. Physical
              Acrylic on paper with pallet knives, brushed with paper edges.{" "}
