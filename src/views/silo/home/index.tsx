  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">RANT by Silo Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the RANT by Silo DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          digital illustration art mixed with elements of graffiti, graphic novels, 90s cartoons,
          and vomited all over the page with random animations and sporadic linework
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/siloHasArt"}
            >
              RANT by Silo
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://lynkfire.com/SiloHasArt"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/silo_has_art/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="silo" dropInfo={DropInfo} />
        </div>
      </div>
    </div>
  );
