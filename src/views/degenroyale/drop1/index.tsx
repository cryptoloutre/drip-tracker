...
export const Drop1DegenRoyale: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Welcome to Degen Royale DRiP Adventures, the brave warriors gather
              to battle for the ultimate treasures. Tune in every week as the
              story unfolds. And claim your exclusive gift on
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
                href={"https://drip.degenroyale.net"}
              >
                Degen Royale
              </a>
            </div>
