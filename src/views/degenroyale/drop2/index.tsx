...
export const Drop2DegenRoyale: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Sometimes victory seems so close, yet you never know what lies
              around the next corner. Tune in next week as the story unfolds.
              And claim your exclusive gift on{" "}
              <a
                target="_blank"
                rel="noreferrer"
                className="text-[#9945FF] font-bold"
