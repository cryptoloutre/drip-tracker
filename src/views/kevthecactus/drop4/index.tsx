    ...
    await Promise.all(
      BorkNFT.map(async (asset) => {
        ...
        const drop = attributes.find(
          (nft) => nft.trait_type == "Drop Number"
        ).value;
        if (drop == dropNumber) {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              Kev&apos;s Fremont High School Talent Show Performance clip. 1981.
              Damaged tape - missing full performance.
            </div>
          </div>
