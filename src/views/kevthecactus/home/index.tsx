  ...
  async function getUserNFT() {
    ...
    const _userNFTsURI = await Promise.all(
      _userNFTs.map(async (asset) => {
        ...
        const drop = attributes.find((nft) => nft.trait_type == "Drop Number").value;
        return {
          uri,
          drop,
        };
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Kev The Cactus Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Kev The Cactus NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Kev is a cactus in a pot. With some hair.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/kevthecactus"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/kevthecactus"}
            >
              Kev The Cactus
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/kev_the_cactus/"}
              >
                Instagram
              </a>
            </div>
          ...
          <div className="flex justify-center">
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              <Link
                href="/kevthecactus/drop1"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Tt2qDhjzxxow0L-GDsBM3pbFTUKQZzOYiKR7DrujR3U?ext=png"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/kevthecactus/drop2"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/x3m1iGmrqKOQrYTaOiZk0iOvuYL8iiVNoAc-mDseK7U?ext=png"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/kevthecactus/drop3"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/opA997wEq9rJsmjt-cChhjfqT_PZQM-TPP6H0sfliRc?ext=png"
                    alt="drop 3 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/kevthecactus/drop4"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/s9g4jCZgxxAA2k1_bW3bSbuV8VIhzIzp_R4HvQ6MNiA?ext=png"
                    alt="drop 4 preview"
                  ></img>
                </div>
