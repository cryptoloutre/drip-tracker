      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop9: <span className="italic">Kikakuma</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Let us be the three wise bears and embody the proverbial principle
              &quot;see no evil, hear no evil, speak no evil&quot;. Mikuma, who sees no
              evil, covering his eyes, Kikakuma, who hears no evil, covering his
              ears, and Iwakuma, who speaks no evil, covering his mouth. See the
              beauty in people, seek the goodness in others and speak with
              kindness. 🐻‍❄️
            </div>
          </div>
