      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop14: <span className="italic">{NFTsInThisDrop[2].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Stay true to who you know yourself to be in your heart. Listen to
              your inner voice, not the expectations or judgments of others.💚
            </div>
          </div>
