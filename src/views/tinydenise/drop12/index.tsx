      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop12: <span className="italic">Tiny Robot Time</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              do the work of one extraordinary man; is a very powerful quote.
              Fail spectacularly. Succeed phenomenally. Be extraordinary! 🤖
            </div>
          </div>
