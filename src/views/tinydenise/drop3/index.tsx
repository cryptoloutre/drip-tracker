      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">Have A GM</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Here&apos;s to an amazing day! Have a nice cuppa coffee, eat the
              best tasting croissant and a great your friends a good ol&apos;
              GM.
            </div>
          </div>
