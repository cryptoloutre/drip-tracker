      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">Take It Easy</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Take your time. Walk a little slower, smell the flowers, feel the
              grass on your back, and breathe the cool air. Take some time to
              disconnect from your devices and re-connect with the earth. Take
              it easy, my friend.
            </div>
          </div>
