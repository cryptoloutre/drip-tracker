      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">Let It Go</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Life can be hectic, and you might feel like everything and
              everyone is against you sometimes. But that&apos;s simply not true.
              Take a deep breath and trust yourself! Great things will follow
              once you let go of things that are out of your control.
            </div>
          </div>
