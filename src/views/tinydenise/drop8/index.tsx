      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop8: <span className="italic">We Come in Peace</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              It would be arrogant to think that we are alone in the universe.
              Always be open to possibilities, and embrace the mysteries and
              unknowns of life! That&apos;s what makes it exciting!
            </div>
          </div>
