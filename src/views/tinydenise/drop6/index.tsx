      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">GM Breakfast Friends</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              If you&apos;re having challenges finding motivation outside your
              sketchbooks, maybe it&apos;s time to take a short break. Be motivated
              outside your screens! Find inspiration in nature, in people, in
              food! Wishing y&apos;all an amazing breakfast and a good morning,
              friends!
            </div>
          </div>
