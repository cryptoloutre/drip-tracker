        ...
        <div className="">
          ...
          <div className="flex justify-center">
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              <Link
                href="/tiiiny/dropvibes2"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/6iCzJT8CsazOGJ3NqE-OQEyGkBHoGdSTN-JAxbM7Eqg?ext=png"
                    alt="drop preview"
                  ></img>
                </div>
                <div className="text-center font-bold mt-1 pb-1">Drop Vibes 2</div>
              </Link>
            </div>
          </div>
        </div>
