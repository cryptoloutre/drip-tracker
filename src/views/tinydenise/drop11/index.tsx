      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop11: <span className="italic">Autumn</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              The leaves will soon start falling beautifully, painting the
              ground with their lovely shades of oranges and browns. Take this
              time to acknowledge how much you&apos;ve grown since the start of the
              year. You are where you should be right now, but believe that you
              will be in a better place in the future. Stay cozy and creative,
              fellas!🍁
            </div>
          </div>
