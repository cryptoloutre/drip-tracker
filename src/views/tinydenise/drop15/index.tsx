      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop15: <span className="italic">{NFTsInThisDrop[2].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Don&apos;t limit your thoughts to the confines of convention.
              Think expansively, without artificial boundaries. Don’t think
              outside the box, think there is NO box. ✨
            </div>
          </div>
