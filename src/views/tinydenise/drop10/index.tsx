      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop10: <span className="italic">Kiiro</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              A Daruma is a traditional luck charm rooted in 5th to 6th century
              Japanese folklore. These tiny guys are a symbol of perseverance in
              the face of adversity. 🎎 🟡 May you be safe, secured and
              protected in your journey.
            </div>
          </div>
