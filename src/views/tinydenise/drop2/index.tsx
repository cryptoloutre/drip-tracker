      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">Peace Love Rock ’n’ SOL</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              I hope your Solana journey brings you good fortune and great
              friends. Peace, Love, Rock &apos;n&apos; SOL!
            </div>
          </div>
