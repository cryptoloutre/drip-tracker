      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop16: <span className="italic">{NFTsInThisDrop[2].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              The soft patter of the rain whispers, &apos;Slow down, you&apos;re moving
              too fast.&apos; It reminds me to take a deep breath and reply, &apos;You&apos;re
              right, I&apos;ll try to enjoy this moment. 💧
            </div>
          </div>
