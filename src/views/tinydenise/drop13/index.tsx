      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop13: <span className="italic">Oubaitori</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              We all bloom at our own pace. Just as flowers blossom when ready,
              we each grow in our own time. There is no race to run but your
              own. Dance to your own tune! Enjoy life and surround yourself with
              supporting people. Have confidence that by staying true to
              yourself, you will bloom into your best. Trust your journey. 🌼
            </div>
          </div>
