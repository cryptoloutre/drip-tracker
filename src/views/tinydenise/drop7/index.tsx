      ...
      <div className="md:hero-content flex">
        <div className="">
          <h1 className="text-center text-3xl font-bold">
            Drop7: <span className="italic">Let&apos;s Bee Kind</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              Being nice comes naturally, but true kindness requires going the
              extra mile; let&apos;s lend a helping hand to those friends who may be
              facing difficult times and together, like a colony of bees, let’s
              build a supportive and caring community!
            </div>
          </div>
