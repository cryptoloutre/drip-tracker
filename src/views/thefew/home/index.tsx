  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">The Few Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the The Few DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            The Few is a small community-based art project with a simple yet
            broad vision: to delve into sources of collective curiosity while
            aiming to enhance the Solana ecosystem along the way. At the moment,
            The Few are collectively curious about the boundaries of art and
            technology in Solana. This DRiP channel shares their lore
            sequentially, a story that depicts their vision through allegory.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/thefewHQ"}
            >
              The Few
            </a>{" "}
            DRiP drop.
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/GX7jsqcTUu2Ti3xwoCe7fO2VXVh6pz_WL7VWnFXrw5Y?ext=jpeg"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/ZKGrjllncIPAjl_OWR2-nrNbIeidFPKQQBypv9lPRE4?ext=png"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/6Q2JPraFHHyi7jKq35wJrBVdUOeRPbsI9ftdPA-Dpsk?ext=png"
                    alt="drop 3 preview"
                  ></img>
                </div>
