  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Dr. Peepee Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Dr. Peepee DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Weekly comics from Dr. Peepee - a former animator for Netflix, Disney, Nickelodeon, Amazon, and more… Topics range from crypto to feelings to Elizabeth Warren to real politicians.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/Doctor_Peepee"}
            >
              Dr. Peepee
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://linktr.ee/doctor_peepee"}
              >
                Website
              </a>
              <a
          ...
          <DropCards artist="drpeepee" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
