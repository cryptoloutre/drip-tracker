...
export const Drop2GrimSyndicate: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">Nazuul</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            Nazuul, the God of Death, shepherded the severed Souls to the Ethereal Plane as famine, war, and pestilence spread.
            </div>
          </div>
