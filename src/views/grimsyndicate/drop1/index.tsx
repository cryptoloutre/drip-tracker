...
export const Drop1GrimSyndicate: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">The Astral Pantheon</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              The pantheon of immortal Astrals ruled the celestial kingdoms with
              impunity. Directing the affairs of all new creations as they
