...
export const Drop3GrimSyndicate: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop3: <span className="italic">The Heralds Call</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
            Eventually, the act of ferrying souls became too much, even for an Astral. Thus Nazuul created the Heralds to assist in his divine work.
            </div>
          </div>
