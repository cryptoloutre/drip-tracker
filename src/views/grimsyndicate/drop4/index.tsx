...
export const Drop4GrimSyndicate: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop4: <span className="italic">{NFTsInThisDrop[0].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              Unlike the life that came before them, great towering beings known
              as Ancients began to emerge and populate the galaxy. They embraced
              Runic Technology and discovered how to travel between the very
              planes of existence.
            </div>
          </div>
          ...
          <div className="flex justify-center mt-4">
            <div className="sm:w-[75%] w-[100%] flex items-center grid grid-cols-2 md:grid-cols-2 gap-2 mt-4">
