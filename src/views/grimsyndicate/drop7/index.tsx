...
export const Drop7GrimSyndicate: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              Once again, from the wastelands of a million worlds, new life
              began to spring forth. This time something new also emerged. Out
              of the inky voidmatter that peppered the cosmic landscape a
              curious creature appeared; a Grim.
            </div>
          </div>
