...
export const Drop6GrimSyndicate: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop6: <span className="italic">{NFTsInThisDrop[0].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              Devastation spread as the Heralds took up the fight against the
              Daemons that poured from the Abyss. In a desperate last stand, the
              Heralds set off the “God Bomb”, wiping out most mortal life to
              preserve their own.
            </div>
          </div>
