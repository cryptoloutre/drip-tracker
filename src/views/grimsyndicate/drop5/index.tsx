...
export const Drop5GrimSyndicate: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop5: <span className="italic">{NFTsInThisDrop[0].name}</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              The use of Runic Technology left tears in the fabric of reality,
              and from those holes, new horrors emerged consuming the Ancient
