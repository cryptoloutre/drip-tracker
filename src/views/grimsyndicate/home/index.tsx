...
export const GrimSyndicateHome: FC = ({}) => {
      ...
      <div className="md:hero-content flex justify-center">
        <div className="">
          ...
          <div className="text-center text-3xl font-bold">
            Track the Grim Syndicate NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            The Grim Syndicate is a multimedia project steeped in lore. The
            project was born on October 1st 2021 and aims to deliver brand
            experiences from gaming to storytelling. We will be delivering drops
            that help shape the story and provide more dimension onto the world
            of the Grim Syndicate. So strap in dear reader and enjoy the show.
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/grimsyndicate"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/Grim__Syndicate"}
            >
              Grim Syndicate
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://discord.com/invite/UAFnJBpgVz"}
              >
                Discord
              </a>
            </div>
          ...
          <div className="flex justify-center">
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              <Link
                href="/grimsyndicate/drop1"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/Ep0dKfD7sw6X1vS3IaasnzKePS4cxMBOGE6FRhM8LbE?ext=jpeg"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/grimsyndicate/drop2"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/88U0DSz_H4Q3j3qXZHu9CeAI73_WAX5iS8rl3B0CnN0?ext=jpeg"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/grimsyndicate/drop4"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/x84pmPzZDnKUxmUsxYyGCmeURQlpxOFu-PWvdgQqPAo?ext=jpg"
                    alt="drop 4 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/grimsyndicate/drop5"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/OuQt6GXpnlhDzmE-4BZiufNSGSRo-PLXJ801xd3SGHo?ext=jpg"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/grimsyndicate/drop6"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/oGPwsgKidxcoFE0SijCkCJphvaWQgn7JRwt83An365E?ext=jpeg"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/grimsyndicate/drop7"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/n4VdPn3gQyZaTVpkkWYU0Dmi4R8ZHujPPA4CFknURqc?ext=jpeg"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/grimsyndicate/drop8"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/vM9xMvQoLvmYOekjz5bRIFNA-LG1VoPu6haVs5uL-Ak?ext=jpeg"
                    alt="drop 8 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/grimsyndicate/drop9"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/ypBFu3FUAQBa6-okmFc1YN1ShkcYbyGkGzWQVEJ1PGA?ext=jpeg"
                    alt="drop 9 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/grimsyndicate/drop10"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/am-7BU3FvsxU4g_ya7wOdrA6EAwW7Wo2Dm3yqHh2B2E?ext=jpeg"
                    alt="drop 10 preview"
                  ></img>
                </div>
