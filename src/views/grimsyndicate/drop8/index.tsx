...
export const Drop8GrimSyndicate: FC = ({}) => {
      ...
      <div className="md:hero-content flex">
        ...
        <div>
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              Nazuul saw something unique in Grims, a life untethered by the
              limitations of a mere Soul existence. Nazuul sought to use Grims
              as the new soul shepherds, arousing a deep jealousy amongst his
              displaced Heralds.
            </div>
          </div>
