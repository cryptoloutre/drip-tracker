      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop2: <span className="italic">Found In Far Away Places</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              Found In Far Away Places is a postcard from photographer Nevin
              Johnson. An ode to his legacy project “Before You Wake,” each
              piece has a part to a poem that when combined makes the poem
              complete. Visit{" "}
              <a
                target="_blank"
                rel="noreferrer"
