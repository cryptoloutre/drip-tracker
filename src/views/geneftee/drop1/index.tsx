      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop1: <span className="italic">Venus of L-Arginine</span> by{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            <div>
              &quot;Venus of L-Arginine. By Wayne Nooten&quot; Hand painted on
              an L-Arginine supplement bottle, this piece is a playful
              interpretation of the Venus of Willendorf, an ancient figurine
              discovered in Austria in 1908 that&apos;s estimated to be 25,000
              years old. It is one of the oldest & most famous surviving works
              of art. Visit{" "}
              <a
                target="_blank"
                rel="noreferrer"
              ...
              for exclusive perks and access the ultimate all in one homepage to
