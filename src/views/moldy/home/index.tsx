            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/oodJYr3ttMwjDpGe4Y3czUU0eOB8_KONEy80HubQjOU?ext=png"
                    alt="drop 6 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/wJStwi1tA7qvAHsod0wxmRElt7sxXsulDCh8PPswEYU?ext=png"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/6ULnvmOIzHcs-jCvAnQqejBgYW8OgkdU_h30ZydGOso?ext=png"
                    alt="drop 8 preview"
                  ></img>
                </div>
