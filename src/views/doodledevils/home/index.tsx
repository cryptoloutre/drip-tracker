...
export const DoodledevilsHome: FC = ({}) => {
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Doodle Devils Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Doodle Devils DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
          Descend into the devilishly cute world of Doodle Devils gaming. In game rewards, events, featured Solana art and media, and much more …
            <br />
            <br />
            Sign up{" "}
            <a
              ...
              href={"https://drip.haus/doodledevils"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/doodledevils"}
            >
              Doodle Devils
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://www.doodledevils.com/"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/doodledevilsnft/"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="doodledevils" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
