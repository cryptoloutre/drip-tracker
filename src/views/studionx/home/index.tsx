...
export const StudioNXHome: FC = ({}) => {
  ...
  async function getUserNFT() {
    ...
    const _userNFTsMain = allUserNFTs.filter(
      (asset) =>
    ...
    const _userNFTsURIMain = await Promise.all(
      _userNFTsMain.map(async (asset) => {
        let attributes: any;
    ...
    const _userNFTsVirus = allUserNFTs.filter(
      (asset) =>
        asset.compression.compressed &&
        asset.grouping[0] != undefined &&
        asset.grouping[0].group_value ==
    ...
    const _userNFTsURIVirus = await Promise.all(
      _userNFTsVirus.map(async (asset) => {
        let attributes: any;
        const uri = asset.content.json_uri;
        if (asset.content.metadata.attributes) {
          attributes = asset.content.metadata.attributes;
    ...
    const _userNFTsURI = _userNFTsURIMain.concat(_userNFTsURIVirus);
  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">StudioNX Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the StudioNX DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Prepare for a serious dose of stoopid as you take a bold step into
            the world of college stoners, beer chugging & fried chicken. Emmy
            winning creators{" "}
            <a
              target="_blank"
              rel="noreferrer"
            ...
            proudly present their insane new web3 comedy Apartment 323.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/wo6MVDiKYtH71mFbX5_-BD0oKA4v0-qb_Yqy3QKiayo?ext=jpg"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/XA7R7g_746l7oTBfG9HrzbqIk3vnDxIfeymGQQMDTJY?ext=jpg"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/_b6NB5xhdRcdfY9Cu5bPkC_cRBYEomtddptjONMJAB0?ext=jpg"
                    alt="drop 4 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/eEoAaEdHcq_Iwu6h29vOwXZ3OlmIE0YwsxNYZE5926U?ext=jpg"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/iNUuJfGZb4tOxQdUHiOpeF2u3qTnUUEHdqXmD2D9xAM?ext=jpg"
                    alt="drop 7 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/t_TrHMXVHCtvRFMSVUx_aNKb5vlMCTdNqxVEN6x4HDE?ext=jpg"
                    alt="drop 8 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/-AybGKyQZ7WfkrPdkYVVg28TEBRlUSkMp6wkkVrd6Oc?ext=jpg"
                    alt="drop 9 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/studionx/drop10"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/qhOF-gUTtsV4WApYpB7TZaPKqeRxg9qJhGQJc9NKaNg?ext=jpg"
                    alt="drop 10 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/studionx/drop12"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/akaPec1Sh2SgFzKBJt0uZ4uzbuOuxKL-ZHJ4a1WB-6c?ext=jpg"
                    alt="drop 12 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/studionx/drop13"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/V288PKFnsQHDbx1XtaP4_af6DyqupQOE3kVIbYMILuE?ext=jpg"
                    alt="drop 13 preview"
                  ></img>
                </div>
              ...
              <Link
                href="/studionx/drop14"
                className="bg-[#000000] pt-1 rounded-xl border-2 border-[#FFFFFF] hover:border-[#14F195]"
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/pdiUru-x0wIAra2ZAyfuUMY5VgqPQJ9engVOG1Jfvvg?ext=jpg"
                    alt="drop 14 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/WIf1AhSSAozMYTkJotQ7YYSuhTC8vntucmbC6qbU4uU?ext=jpg"
                    alt="drop 2 preview"
                  ></img>
                </div>
