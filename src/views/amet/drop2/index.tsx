      ...
      <div className="md:hero-content flex">
        ...
        <div>
          <h1 className="text-center text-3xl font-bold">
            Drop{dropNumber}: <span className="italic">{NFTsInThisDrop[0].name}, {NFTsInThisDrop[1].name}, {NFTsInThisDrop[2].name} & {NFTsInThisDrop[3].name} </span> by {" "} 
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <div className="mt-12 w-[100%] mx-auto">
            ...
            This drop features 3 rarities:
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 14511)</span>
              .<br />
              <br />• The{" "}
              <span className="text-[#a5a5a5] font-bold">Common</span> drop is{" "}
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 14510)</span>
              .<br />
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 14509)</span>.
            </div>
          </div>
