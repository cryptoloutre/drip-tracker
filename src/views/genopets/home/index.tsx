  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Genopets Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Genopets DRiP NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            ...
            is a free-to-play, move-to-earn mobile game that makes it fun and
            rewarding to live an active lifestyle. Bank your steps every day to
            level up, customize, and evolve your own Genopet! Download Genopets
            for Android or iOS and use invite code “drip” to claim a welcome
            bonus and start playing today. <br />
            Sign up{" "}
            <a
              target="_blank"
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://drip.haus/genopets"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            ...
            <a
                ...
                href={"https://mainframe.genopets.me/drip"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://discord.com/invite/genopets"}
              >
                Discord
              </a>
            </div>
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/bnSiCmLCgXYlBrP3OKRs_dUhc-XynjMAjeAprVuNPMU?ext=png"
                    alt="drop 1 preview"
                  ></img>
                </div>
