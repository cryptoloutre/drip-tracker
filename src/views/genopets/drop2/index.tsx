  ...
  async function getUserNFT() {
    ...
    await Promise.all(
      season2NFT.map(async (asset) => {
        ...
        const drop = attributes.find((nft) => nft.trait_type == "Season").value;
        if (drop == dropNumber) {
        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 53,8k)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[1].name}</span>{" "}{NFTsInThisDrop[1].description}{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 1.7k)</span>
              .
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 560)</span>.
            </div>
          </div>
