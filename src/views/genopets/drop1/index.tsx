        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            <div>
              ...
              <span className="italic">{NFTsInThisDrop[0].name}</span>: Amidst
              Gentle Clouds, a Serene Expanse.{" "}
              <span className="text-[#a5a5a5] font-bold">(supply: 43643)</span>
              .
              <br />• The <span className="text-[#E6C15A] font-bold">
                Rare
              </span>{" "}
              drop is <span className="italic">{NFTsInThisDrop[1].name}</span>:
              A Mirage of Light and Imagination.{" "}
              <span className="text-[#E6C15A] font-bold">(supply: 2321)</span>
              .
              <br />• The{" "}
              <span className="text-[#14F195] font-bold">Legendary</span> drop
              is <span className="italic">{NFTsInThisDrop[2].name}</span>: Where
              Nature&apos;s Pulse Meets Digital Heartbeats.{" "}
              <span className="text-[#14F195] font-bold">(supply: 464)</span>.
            </div>
          </div>
