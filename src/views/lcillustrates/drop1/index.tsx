...
export const Drop1Lcillustrates: FC = ({}) => {
        ...
        <div>
          ...
          <div className="mt-12 sm:w-[70%] mx-auto">
            ...
            This drop features 3 rarities:
              ...
              <span className="text-[#a5a5a5] font-bold">(supply: 36406)</span>
              .<br />
              ...
              <span className="text-[#E6C15A] font-bold">(supply: 8647)</span>
              .<br />
              <br />• The{" "}
              ...
              <span className="text-[#14F195] font-bold">(supply: 455)</span>.
            </div>
          </div>
