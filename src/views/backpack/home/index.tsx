  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">Backpack Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the Backpack NFTs you are missing
          </div>
          <div className="mt-8 sm:w-[70%] mx-auto">
            Backpack works with different artists and teams to bring you high
            quality news, entertainment, and collectibles. As the creators of
            Mad Lads, you can expect to see the collection make numerous
            appearances, from Mad Lads artwork to Roster content.
            <br />
            <br />
            Sign up{" "}
            <a
            ...
            <div className="w-[70%] md:w-[50%] flex items-center grid grid-cols-2 sm:grid-cols-3 gap-4 mt-4">
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/oUAE0Pe9CD6OrDtPfXFYseSURYWlZsaBOujFT6tKImE?ext=png"
                    alt="drop 1 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/vJZloGItHaFFUNguWg6nOr-LV8ycwkIf6AejWw__5z0?ext=png"
                    alt="drop 2 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/yfQkRL0-BSaw-CxbDWr00dpFufYnxsSSyyG1izFHc3I?ext=gif"
                    alt="drop 4 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/5nfl7uAKPHkdcqEROM8D_y4zHuKK9_TA9qFjxQQ7V0I?ext=gif"
                    alt="drop 5 preview"
                  ></img>
                </div>
              ...
              >
                <div className="flex justify-center">
                  <img
                    className=""
                    src="https://arweave.net/BiHHhHPKeCVoJNzMoFbaloyvyroGv8VkYqwsksECuKg?ext=gif"
                    alt="drop 6 preview"
                  ></img>
                </div>
