  ...
  return (
    <div className="md:hero mx-auto p-4">
      <div className="md:hero-content flex justify-center">
        <div className="">
          <h1 className="font-bold text-4xl text-center">THE WHALES Drop</h1>
          <div className="text-center text-3xl font-bold">
            Track the THE WHALES DRiP NFTs you are missing
          </div>
          ...
          Second single "Hunned Racks" ft. MadeinTYO and Tkay Maidza out soon!
            ...
            <a
              ...
              href={"https://drip.haus/thewhales"}
            >
              here
            </a>{" "}
            to never miss a{" "}
            <a
              ...
              rel="noreferrer"
              className="text-[#9945FF] font-bold"
              href={"https://twitter.com/thewhalesmusic"}
            >
              THE WHALES
            </a>{" "}
            DRiP drop.
            <div className="mt-4 flex text-xl">
              <a
                ...
                href={"https://linktr.ee/thewhales_"}
              >
                Website
              </a>
              <a
              ...
              <a
                ...
                rel="noreferrer"
                className="text-[#9945FF] underline font-bold mr-4"
                href={"https://www.instagram.com/thewhalesmusic"}
              >
                Instagram
              </a>
            </div>
          ...
          <DropCards artist="thewhales" dropInfo={DropInfo}/>
        </div>
      </div>
    </div>
  );
